...
using n12 = _VL_CoreLib_Windows_.System.Windows.Advanced;
using n20 = _CoreLibBasics_.Control;
using n14 = e2::VL.Lib.Mathematics;
using n6 = _VL_CoreLib_Windows_;
using n8 = e2::VL.Lib.Primitive.Object;
using n7 = e5::VL.Core.CompilerServices;
using n16 = global::System.Collections.Generic;
using n15 = e1::Stride.Core.Mathematics;
using n18 = e2::VL.Lib.Primitive.CacheRegion;
using n1 = e5::VL.Core;
using n2 = global::System;
using n13 = _CoreLibBasics_._2D.RectangleAnchor;
using n5 = _VL_CoreLib_Windows_.System.Windows;
using n10 = global::System.Windows.Forms;
using n4 = e17::VL.CoreLib.Windows.DllImport;
using n11 = global::System.Runtime.CompilerServices;
using n9 = global::System.Drawing;

namespace _VL_CoreLib_Windows_.System.Windows
{
    [n1.ElementAttribute(TracingId = 90311U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "TXbwxGLVQe9QXZeFcq3TYX", Name = "WindowState_TXbwxGLVQe9QXZeFcq3TYX")]
    [n2.SerializableAttribute]
    public class WindowState_TXbwxGLVQe9QXZeFcq3TYX : n1.VLObject, n2.IDisposable
    {
        [n7.CreateNewAttribute]
        public static n5.WindowState_TXbwxGLVQe9QXZeFcq3TYX Create(n1.NodeContext Node_Context)
        {
        ...
        public static n5.WindowState_TXbwxGLVQe9QXZeFcq3TYX CreateDefault()
        {
            var instance = new WindowState_TXbwxGLVQe9QXZeFcq3TYX(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n5.WindowState_TXbwxGLVQe9QXZeFcq3TYX Update(n10.Form Input_In, out n10.Form Output_Out, out string Caption_Out, out n10.FormBorderStyle Border_Style_Out, out bool Control_Box_Out, out n10.FormWindowState State_Out, out bool Visible_Out)
        {
            n8.ObjectHelpers.IsAssigned(x: Input_In, result: out bool Result_0, notAssigned: out bool Not_Assigned_1);
        ...
        public n5.WindowState_TXbwxGLVQe9QXZeFcq3TYX __Create__(n1.NodeContext Node_Context)
        {
            n11.RuntimeHelpers.EnsureSufficientExecutionStack();
            return this;
        }

        public n5.WindowState_TXbwxGLVQe9QXZeFcq3TYX __CreateDefault__()
        {
            return this;
        }
    ...
    [n1.ElementAttribute(TracingId = 90684U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "NN7pI7FI1mWOUtJE7erhXK", Name = "SetWindowState_NN7pI7FI1mWOUtJE7erhXK")]
    [n2.SerializableAttribute]
    public class SetWindowState_NN7pI7FI1mWOUtJE7erhXK : n1.VLObject, n2.IDisposable
    {
        [n7.CreateNewAttribute]
        public static n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK Create(n1.NodeContext Node_Context)
        {
        ...
        [n7.CreateDefaultAttribute]
        public static n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK CreateDefault()
        {
            var instance = new SetWindowState_NN7pI7FI1mWOUtJE7erhXK(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK Update(n10.Form Input_In, [n7.SerializedDefaultValueAttribute("Renderer", false)] string Caption_In, [n7.SerializedDefaultValueAttribute("Sizable", false)] n10.FormBorderStyle Border_Style_In, bool Control_Box_In, n10.FormWindowState State_In, [n7.SerializedDefaultValueAttribute("True", false)] bool Visible_In, out n10.Form Output_Out)
        {
            n8.ObjectHelpers.IsAssigned(x: Input_In, result: out bool Result_0, notAssigned: out bool Not_Assigned_1);
            ...
            if (Result_0)
            {
                ...
                {
                    manager_5 = new n18.Manager<n2.ValueTuple<n10.Form, n10.FormBorderStyle>, n2.ValueTuple<n10.Form>>(n2.ValueTuple.Create(default(n10.Form)));
                }
                ...
                {
                    manager_13 = new n18.Manager<n2.ValueTuple<n10.Form, n10.FormWindowState>, n2.ValueTuple<n10.Form>>(n2.ValueTuple.Create(default(n10.Form)));
                }
                ...
                {
                    manager_21 = new n18.Manager<n2.ValueTuple<n10.Form, string>, n2.ValueTuple<n10.Form>>(n2.ValueTuple.Create(default(n10.Form)));
                }
                ...
                {
                    manager_29 = new n18.Manager<n2.ValueTuple<n10.Form, bool>, n2.ValueTuple<n10.Form>>(n2.ValueTuple.Create(default(n10.Form)));
                }
                ...
                {
                    manager_37 = new n18.Manager<n2.ValueTuple<n10.Form, bool>, n2.ValueTuple>(n2.ValueTuple.Create());
                }
            ...
            Output_Out = Input_In;
            n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK that_42 = this;
        ...
        public n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK __Create__(n1.NodeContext Node_Context)
        {
            n11.RuntimeHelpers.EnsureSufficientExecutionStack();
            n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK that_0 = this;
            this.__if_U4BHa2hVrMQPvSivNO2QG9 = default(n2.Object);
            return that_0;
        }

        public n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK __CreateDefault__()
        {
            n5.SetWindowState_NN7pI7FI1mWOUtJE7erhXK that_0 = this;
            this.__if_U4BHa2hVrMQPvSivNO2QG9 = default(n2.Object);
            return that_0;
        ...
        public class __A8EanqGospJPRBsIHo2xEA : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 90716U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "NwM3PMsm02aOKCLsQvEwEJ", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
            public n18.Manager<n2.ValueTuple<n10.Form, n10.FormBorderStyle>, n2.ValueTuple<n10.Form>> __cache_NwM3PMsm02aOKCLsQvEwEJ = null;
            [n1.ElementAttribute(TracingId = 90772U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "UVUrx2fND4qMrFHmOBXWsp", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
            public n18.Manager<n2.ValueTuple<n10.Form, n10.FormWindowState>, n2.ValueTuple<n10.Form>> __cache_UVUrx2fND4qMrFHmOBXWsp = null;
            [n1.ElementAttribute(TracingId = 90830U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "TgUrDTKfx95PscGIJ8kC3t", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
            public n18.Manager<n2.ValueTuple<n10.Form, string>, n2.ValueTuple<n10.Form>> __cache_TgUrDTKfx95PscGIJ8kC3t = null;
            [n1.ElementAttribute(TracingId = 90936U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "S8BFEpBiJDPMUH0PxpKDJr", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
            public n18.Manager<n2.ValueTuple<n10.Form, bool>, n2.ValueTuple<n10.Form>> __cache_S8BFEpBiJDPMUH0PxpKDJr = null;
            [n1.ElementAttribute(TracingId = 90881U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "RE1AmFIB3pkLGDXOovnywU", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
            public n18.Manager<n2.ValueTuple<n10.Form, bool>, n2.ValueTuple> __cache_RE1AmFIB3pkLGDXOovnywU = null;
            ...
            internal __A8EanqGospJPRBsIHo2xEA __WITH__(n18.Manager<n2.ValueTuple<n10.Form, n10.FormBorderStyle>, n2.ValueTuple<n10.Form>> __cache_NwM3PMsm02aOKCLsQvEwEJ, n18.Manager<n2.ValueTuple<n10.Form, n10.FormWindowState>, n2.ValueTuple<n10.Form>> __cache_UVUrx2fND4qMrFHmOBXWsp, n18.Manager<n2.ValueTuple<n10.Form, string>, n2.ValueTuple<n10.Form>> __cache_TgUrDTKfx95PscGIJ8kC3t, n18.Manager<n2.ValueTuple<n10.Form, bool>, n2.ValueTuple<n10.Form>> __cache_S8BFEpBiJDPMUH0PxpKDJr, n18.Manager<n2.ValueTuple<n10.Form, bool>, n2.ValueTuple> __cache_RE1AmFIB3pkLGDXOovnywU)
            {
    ...
    [n1.ElementAttribute(TracingId = 91152U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "AMQAfEPV6P2OO4P09IyY5H", Name = "SetWindowMode_AMQAfEPV6P2OO4P09IyY5H")]
    [n2.SerializableAttribute]
    public class SetWindowMode_AMQAfEPV6P2OO4P09IyY5H : n1.VLObject, n2.IDisposable
    {
        [n7.CreateNewAttribute]
        public static n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H Create(n1.NodeContext Node_Context)
        {
        ...
        [n7.CreateDefaultAttribute]
        public static n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H CreateDefault()
        {
            var instance = new SetWindowMode_AMQAfEPV6P2OO4P09IyY5H(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H Update(n10.Form Input_In, [n7.SerializedDefaultValueAttribute("False", false)] bool Hide_In, [n7.SerializedDefaultValueAttribute("False", false)] bool Windowed_In, [n7.SerializedDefaultValueAttribute("False", false)] bool Fullscreen_In, out n10.Form Output_Out)
        {
            n8.ObjectHelpers.IsAssigned(x: Input_In, result: out bool Result_0, notAssigned: out bool Not_Assigned_1);
            ...
            if (Output_11)
            {
                ...
                n19._Operations_.CastAs<n10.Form>(Input_In: Input_In, Default_In: Default_14, Result_Out: out n10.Form Result_15, Success_Out: out bool Success_16);
            ...
            if (Output_22)
            {
                ...
                n19._Operations_.CastAs<n10.Form>(Input_In: Input_In, Default_In: Default_25, Result_Out: out n10.Form Result_26, Success_Out: out bool Success_27);
            ...
            Output_Out = Input_In;
            n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H that_32 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H __Create__(n1.NodeContext Node_Context)
        {
            n11.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("HylXxkKPeF0O6LWz4fSQKo", "CLzuQlGLmqZPpM8nyXNQsd", 91204U);
            var Output_1 = n20.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("HylXxkKPeF0O6LWz4fSQKo", "EQ3KXZ8RHaPMwIccSqKhg1", 91316U);
            var Output_3 = n20.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_2);
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("HylXxkKPeF0O6LWz4fSQKo", "P3ibP9sQZc8O3fDal6XLX1", 91493U);
            var Output_5 = n20.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_4);
            n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H that_6 = this;
        ...
        public n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H __CreateDefault__()
        {
            n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H that_0 = this;
            this.__p_CLzuQlGLmqZPpM8nyXNQsd = n20.TogEdge_GJoUlOOEtqiM4g67HVecyr.CreateDefault();
            this.__p_EQ3KXZ8RHaPMwIccSqKhg1 = n20.TogEdge_GJoUlOOEtqiM4g67HVecyr.CreateDefault();
            this.__p_P3ibP9sQZc8O3fDal6XLX1 = n20.TogEdge_GJoUlOOEtqiM4g67HVecyr.CreateDefault();
            return that_0;
        }
        ...
        [n1.ElementAttribute(TracingId = 91204U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "CLzuQlGLmqZPpM8nyXNQsd", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        public n20.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_CLzuQlGLmqZPpM8nyXNQsd;
        [n1.ElementAttribute(TracingId = 91316U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "EQ3KXZ8RHaPMwIccSqKhg1", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        public n20.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_EQ3KXZ8RHaPMwIccSqKhg1;
        ...
        [n1.ElementAttribute(TracingId = 91493U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "P3ibP9sQZc8O3fDal6XLX1", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        public n20.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_P3ibP9sQZc8O3fDal6XLX1;
        [n1.ElementAttribute(IsAutoGenerated = true)]
        ...
        internal SetWindowMode_AMQAfEPV6P2OO4P09IyY5H __WITH__(n20.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_CLzuQlGLmqZPpM8nyXNQsd, n20.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_EQ3KXZ8RHaPMwIccSqKhg1, n20.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_P3ibP9sQZc8O3fDal6XLX1)
        {
            n5.SetWindowMode_AMQAfEPV6P2OO4P09IyY5H that_0 = this;
            if (this.__GetContext__().IsImmutable)
...
{
    [n1.ElementAttribute(TracingId = 90304U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", Name = "_Operations_")]
    public static partial class _Operations_
    {
        ...
        {
            var Result_0 = n4.User32.FindWindow(lpClassName: Class_Name_In, lpWindowName: Window_Title_In);
            Result_Out = Result_0;
            return;
        }

        public static void Rectangle_Split(n9.Rectangle Input_In, out int Left_Out, out int Top_Out, out int Width_Out, out int Height_Out)
        {
        ...
        public static void FromWinFormsRectangle(n9.Rectangle Input_In, out n15.RectangleF Output_Out)
        {
            n12._Operations_.Rectangle_Split(Input_In: Input_In, Left_Out: out int Left_0, Top_Out: out int Top_1, Width_Out: out int Width_2, Height_Out: out int Height_3);
            float Position_X_4 = (float)Left_0;
            float Position_Y_5 = (float)Top_1;
            float Width_6 = (float)Width_2;
            float Height_7 = (float)Height_3;
            n14.RectangleAnchor Anchor_8 = n13._Operations_.CreateDefault();
            n14.RectangleNodes.JoinComponentwise(positionX: Position_X_4, positionY: Position_Y_5, width: Width_6, height: Height_7, anchor: Anchor_8, output: out n15.RectangleF Output_9);
            Output_Out = Output_9;
            return;
        }

        public static void ToWinFormsRectangle(n15.RectangleF Input_In, out n9.Rectangle Output_Out)
        {
            n14.RectangleAnchor Anchor_0 = n13._Operations_.CreateDefault();
            n14.RectangleNodes.Split(input: ref Input_In, anchor: Anchor_0, position: out n15.Vector2 Position_1, size: out n15.Vector2 Size_2);
            n14.Vector2Nodes.Vector(input: ref Position_1, x: out float X_3, y: out float Y_4);
            var Result_5 = n17.Float32Extensions.Round(input: X_3);
            var Result_6 = n17.Float32Extensions.Round(input: Y_4);
            n14.Vector2Nodes.Vector(input: ref Size_2, x: out float X_7, y: out float Y_8);
            var Result_9 = n17.Float32Extensions.Round(input: X_7);
            var Result_10 = n17.Float32Extensions.Round(input: Y_8);
            var Output_11 = new n9.Rectangle(x: Result_5, y: Result_6, width: Result_9, height: Result_10);
...
{
    [n1.ElementAttribute(TracingId = 92111U, DocumentId = "HylXxkKPeF0O6LWz4fSQKo", PersistentId = "V0lbEGih4KhP8dFotKJ54C", Name = "VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C")]
    [n2.SerializableAttribute]
    public class VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C : n1.VLObject, n2.IDisposable
    {
        [n7.CreateNewAttribute]
        public static n6.VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C Create(n1.NodeContext Node_Context)
        {
        ...
        [n7.CreateDefaultAttribute]
        public static n6.VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C CreateDefault()
        {
            var instance = new VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n6.VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C Update()
        {
            return this;
        }

        public n6.VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C __Create__(n1.NodeContext Node_Context)
        {
            n11.RuntimeHelpers.EnsureSufficientExecutionStack();
            return this;
        }

        public n6.VL_CoreLib_WindowsApplication_V0lbEGih4KhP8dFotKJ54C __CreateDefault__()
        {
            return this;
        }
