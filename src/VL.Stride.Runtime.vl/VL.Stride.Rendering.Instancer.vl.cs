...
using n19 = e2::VL.Lib.Mathematics;
using n48 = _System_Memory_.System.Advanced.Adaptive;
using n9 = e40::VL.Stride.Graphics;
using n33 = _CoreLibBasics_.Animation.IClock.Advanced;
using n10 = e40::VL.Stride.Rendering;
using n3 = e27::Stride.Graphics;
using n34 = e5::VL.Lib.Animation;
using n4 = _VL_Stride_Rendering_Instancer_.Stride.Rendering;
using n7 = e2::VL.Lib.Primitive.Object;
...
using n23 = e5::VL.Lib.Collections;
...
{
    [n1.ElementAttribute(TracingId = 168058U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "FBHuNRR7L9ALXC8p0GP3eB", Name = "StreamOutInstancer_FBHuNRR7L9ALXC8p0GP3eB")]
    ...
    public class StreamOutInstancer_FBHuNRR7L9ALXC8p0GP3eB<T> : n1.VLObject, n2.IDisposable
    {
            ...
            where AdM : struct, n5.IAdaptiveCreateDefault<T[]>
        {
            ...
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "C92R2lWxcjpMp2fL4EReyK", 168161U);
            ...
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "AgLdJpYx4ohM24BRpVck8U", 168063U);
            var Output_7 = n28.DynamicBuffer_C82b44KM7nmOgoP82JqMWO<T[]>.Create(Node_Context: Node_Context_6);
            n1.NodeContext Node_Context_8 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "Pik1hNA6CYgLdYApdOVPVl", 168102U);
            var Output_9 = n28.ComputeBuffer_DmEfvnY9LhgL0IgudEOxyM.Create(Node_Context: Node_Context_8);
            n1.NodeContext Node_Context_10 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "Sl9gmDMFzcDPX7btyM5wuz", 168130U);
            ...
            n1.NodeContext Node_Context_13 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "Fk69ptSPXAiQCGG9JKQBfK", 168214U);
            var Output_14 = n4.MeshDrawerStreamOut_C.Create(Node_Context: Node_Context_13);
            n1.NodeContext Node_Context_15 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "TPv3FYpjnrHLfSK49Gi7KL", 168226U);
            var Output_16 = n29.RenderEntity_HYRtmvUkSb6PheJUi3kp3r.Create(Node_Context: Node_Context_15);
            n1.NodeContext Node_Context_17 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "Mqpo2zCE1uyMDUj0hjTWm8", 168259U);
            var Output_18 = n30.Group_TqwCZl6Gra4OmgvUg1POgm.Create(Node_Context: Node_Context_17);
            n1.NodeContext Node_Context_19 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "K30vX2JIRdrOEEQwSBQY10", 168282U);
            var Output_20 = n31.Pos3Norm3Tex2_T5nlQ9NTaLdQAGRzwKUdRc.Create(Node_Context: Node_Context_19);
            n1.NodeContext Node_Context_21 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "IpTgJtfhVBpOIAiPoMMZ03", 168335U);
            ...
            n1.NodeContext Node_Context_24 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "AzGGOnslQHgM5XvM4edg4v", 168348U);
            ...
            n1.NodeContext Node_Context_26 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "HsiNjGnaf8oO5LkWShBzhZ", 168462U);
            ...
            n1.NodeContext Node_Context_29 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "LYKVdsFMChTO0L21jVuOeI", 168472U);
            ...
            n1.NodeContext Node_Context_32 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "OFp8JdoWuZUOXalQi37qBD", 168481U);
            ...
            n1.NodeContext Node_Context_35 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "CmxSHi24Yb3MY0DqaTolM1", 168500U);
            var Output_36 = n32.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_35);
            n1.NodeContext Node_Context_37 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "EKy8KJ6D6rIQP1vxlGAoln", 168529U);
        ...
        [n1.ElementAttribute(TracingId = 168189U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "BjQCtqINP9xMTpLPb1A4yn", Name = "__slot_BjQCtqINP9xMTpLPb1A4yn")]
        ...
        [n1.ElementAttribute(TracingId = 168193U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "NfZmTOrrk3GNfQ470J2Dma", Name = "__slot_NfZmTOrrk3GNfQ470J2Dma")]
        public static bool __slot_NfZmTOrrk3GNfQ470J2Dma = true;
        [n1.ElementAttribute(TracingId = 168298U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "CLnZGzf3gxXOk9nlb63RCu", Name = "__slot_CLnZGzf3gxXOk9nlb63RCu")]
        public static string __slot_CLnZGzf3gxXOk9nlb63RCu = "transformation buffer";
        [n1.ElementAttribute(TracingId = 168311U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "VeUCMKwr9MIL6S9xP2QKeU", Name = "__slot_VeUCMKwr9MIL6S9xP2QKeU")]
        public static string __slot_VeUCMKwr9MIL6S9xP2QKeU = "geometry shader";
        [n1.ElementAttribute(TracingId = 168325U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "CMcNnKyMzPbQGuernphriQ", Name = "__slot_CMcNnKyMzPbQGuernphriQ")]
        public static string __slot_CMcNnKyMzPbQGuernphriQ = "stream out draw call";
        [n1.ElementAttribute(TracingId = 168345U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "KT91ezfzY9oPV7ZcdEP4gE", Name = "__slot_KT91ezfzY9oPV7ZcdEP4gE")]
        public static string __slot_KT91ezfzY9oPV7ZcdEP4gE = "StreamOut Instancer Model";
        [n1.ElementAttribute(TracingId = 168346U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "EMwZe5JLMYxO39XVkdWaho", Name = "__slot_EMwZe5JLMYxO39XVkdWaho")]
        public static string __slot_EMwZe5JLMYxO39XVkdWaho = "StreamOut Instancer";
        [n1.ElementAttribute(TracingId = 168347U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "AhXI63kyHHkOH2jelo9LY6", Name = "__slot_AhXI63kyHHkOH2jelo9LY6")]
        public static string __slot_AhXI63kyHHkOH2jelo9LY6 = "StreamOut Instancer Group";
        [n1.ElementAttribute(TracingId = 168527U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "QniUHjPL2auMFnFNR9c1Lt", Name = "__slot_QniUHjPL2auMFnFNR9c1Lt")]
        public n14.Vector3 __slot_QniUHjPL2auMFnFNR9c1Lt;
        [n1.ElementAttribute(TracingId = 168578U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "FwaP69AYYNiNsVEEN3nAm4", Name = "__slot_FwaP69AYYNiNsVEEN3nAm4")]
        ...
        [n1.ElementAttribute(TracingId = 168130U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Sl9gmDMFzcDPX7btyM5wuz", Name = "AnalyzeMesh", IsManaged = true, IsAutoGenerated = true)]
        public n4.AnalyzeMesh_Jeoc7D9B7h9PBUqptKAvLO __p_Sl9gmDMFzcDPX7btyM5wuz;
        [n1.ElementAttribute(TracingId = 168282U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "K30vX2JIRdrOEEQwSBQY10", Name = "Pos3Norm3Tex2", IsManaged = true, IsAutoGenerated = true)]
        public n31.Pos3Norm3Tex2_T5nlQ9NTaLdQAGRzwKUdRc __p_K30vX2JIRdrOEEQwSBQY10;
        [n1.ElementAttribute(TracingId = 168102U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Pik1hNA6CYgLdYApdOVPVl", Name = "ComputeBuffer", IsManaged = true, IsAutoGenerated = true)]
        public n28.ComputeBuffer_DmEfvnY9LhgL0IgudEOxyM __p_Pik1hNA6CYgLdYApdOVPVl;
        [n1.ElementAttribute(TracingId = 168063U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "AgLdJpYx4ohM24BRpVck8U", Name = "DynamicBuffer", IsManaged = true, IsAutoGenerated = true)]
        public n28.DynamicBuffer_C82b44KM7nmOgoP82JqMWO<T[]> __p_AgLdJpYx4ohM24BRpVck8U;
        [n1.ElementAttribute(TracingId = 168199U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "RrLpUEnP1jHMtQrcOlloKy", Name = "InstancedMeshStreamOutShader", IsManaged = true, IsAutoGenerated = true, NodeName = "InstancedMeshStreamOutShader", NodeCategory = "Stride.Rendering.DrawShaders")]
        public n1.IVLNode __p_RrLpUEnP1jHMtQrcOlloKy;
        [n1.ElementAttribute(TracingId = 168214U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Fk69ptSPXAiQCGG9JKQBfK", Name = "MeshDrawerStreamOut", IsManaged = true, IsAutoGenerated = true)]
        public n4.MeshDrawerStreamOut_C __p_Fk69ptSPXAiQCGG9JKQBfK;
        [n1.ElementAttribute(TracingId = 168335U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "IpTgJtfhVBpOIAiPoMMZ03", Name = "FrameDelay", IsManaged = true, IsAutoGenerated = true)]
        public n32.FrameDelay_VYPkCl1PIexL9IROxeL6ju<int> __p_IpTgJtfhVBpOIAiPoMMZ03;
        [n1.ElementAttribute(TracingId = 168161U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "C92R2lWxcjpMp2fL4EReyK", Name = "VertexBufferModelEntity", IsManaged = true, IsAutoGenerated = true)]
        public n4.VertexBufferModelEntity_V0gZTBaXuOlOokaX9Jnq6v __p_C92R2lWxcjpMp2fL4EReyK;
        [n1.ElementAttribute(TracingId = 168529U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "EKy8KJ6D6rIQP1vxlGAoln", Name = "FrameDelay", IsManaged = true, IsAutoGenerated = true)]
        public n32.FrameDelay_VYPkCl1PIexL9IROxeL6ju<bool> __p_EKy8KJ6D6rIQP1vxlGAoln;
        [n1.ElementAttribute(TracingId = 168348U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "AzGGOnslQHgM5XvM4edg4v", Name = "AsyncTask", IsManaged = true, IsAutoGenerated = true)]
        public n20.AsyncTask<n14.BoundingBox> __p_AzGGOnslQHgM5XvM4edg4v;
        [n1.ElementAttribute(TracingId = 168462U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "HsiNjGnaf8oO5LkWShBzhZ", Name = "HoldLatest", IsManaged = true, IsAutoGenerated = true)]
        public n20.HoldLatest<n14.BoundingBox> __p_HsiNjGnaf8oO5LkWShBzhZ;
        [n1.ElementAttribute(TracingId = 168226U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "TPv3FYpjnrHLfSK49Gi7KL", Name = "RenderEntity", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 168259U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Mqpo2zCE1uyMDUj0hjTWm8", Name = "Group", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 168472U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "LYKVdsFMChTO0L21jVuOeI", Name = "Changed", IsManaged = true, IsAutoGenerated = true)]
        public n32.Changed_A8JGbead2bxNdnPybiEqVS<T[]> __p_LYKVdsFMChTO0L21jVuOeI;
        [n1.ElementAttribute(TracingId = 168481U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "OFp8JdoWuZUOXalQi37qBD", Name = "MonoFlop", IsManaged = true, IsAutoGenerated = true)]
        public n32.MonoFlop_GeOV3KtNF5BPYMkYFPPAst __p_OFp8JdoWuZUOXalQi37qBD;
        [n1.ElementAttribute(TracingId = 168500U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "CmxSHi24Yb3MY0DqaTolM1", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        ...
        public class __KlDK8r8CxyZMcOFG1If084 : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 168549U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "UX0PvcaX7j0Ps1JM0VwWU3", Name = "BoxMesh", IsManaged = true, IsAutoGenerated = true, NodeName = "BoxMesh", NodeCategory = "Stride.Models.Meshes")]
        ...
        public class __VVEBQHVkzTVLbjPJAdpnB7 : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 168457U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "PuFKxd0ytmXOOeZDMxUJR1", Name = "__slot_PuFKxd0ytmXOOeZDMxUJR1")]
    ...
    [n1.ElementAttribute(TracingId = 168715U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Jeoc7D9B7h9PBUqptKAvLO", Name = "AnalyzeMesh_Jeoc7D9B7h9PBUqptKAvLO")]
    [n2.SerializableAttribute]
    public class AnalyzeMesh_Jeoc7D9B7h9PBUqptKAvLO : n1.VLObject, n2.IDisposable
    {
        ...
        [n1.ElementAttribute(TracingId = 168723U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "D39C2NzScu1QPzSJiNtBJw", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 169606U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "V0gZTBaXuOlOokaX9Jnq6v", Name = "VertexBufferModelEntity_V0gZTBaXuOlOokaX9Jnq6v")]
    [n2.SerializableAttribute]
    public class VertexBufferModelEntity_V0gZTBaXuOlOokaX9Jnq6v : n1.VLObject, n2.IDisposable
    {
        ...
        {
            n25.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "FxwbAGlYcWyMfqSRUgL0oA", 169632U);
            ...
            n1.NodeContext Node_Context_8 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "ARVylOsN7WtONhh7OeAAza", 169612U);
        ...
        [n1.ElementAttribute(TracingId = 169632U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "FxwbAGlYcWyMfqSRUgL0oA", Name = "StreamOutModelComponent", IsManaged = true, IsAutoGenerated = true)]
        public n4.StreamOutModelComponent_C __p_FxwbAGlYcWyMfqSRUgL0oA;
        [n1.ElementAttribute(TracingId = 169612U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "ARVylOsN7WtONhh7OeAAza", Name = "Entity", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 169743U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "PJgyWNdTkGvLdtBMDaYOhz", Name = "MeshDrawerStreamOut_C")]
    [n2.SerializableAttribute]
    public class MeshDrawerStreamOut_C : n1.VLObject, n8.IGraphicsRendererBase, n2.IDisposable
    {
        ...
        public n4.MeshDrawerStreamOut_C __Create__(n1.NodeContext Node_Context)
        {
            ...
            n1.NodeContext Node_Context_3 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "G90yNPVlSvXMV1azhcbDyL", 169990U);
            ...
            n1.NodeContext Node_Context_13 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "EJsPsVwiyG1PjQM0gXqj4H", 169900U);
        ...
        [n1.ElementAttribute(TracingId = 169770U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "EGc7lmBvlM4LpSh9Wm34KT", Name = "__slot_EGc7lmBvlM4LpSh9Wm34KT")]
        ...
        [n1.ElementAttribute(TracingId = 169771U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "KUf4UeoynGHMx4bWkye3Ul", Name = "__slot_KUf4UeoynGHMx4bWkye3Ul")]
        ...
        [n1.ElementAttribute(TracingId = 169893U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "FwAsFM2LAazNA5LjNSl4o5", Name = "__slot_FwAsFM2LAazNA5LjNSl4o5")]
        ...
        [n1.ElementAttribute(TracingId = 169976U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "RCmUrP0i3FoMIg2Lm0szhu", Name = "__slot_RCmUrP0i3FoMIg2Lm0szhu")]
        public n8.MeshDraw __slot_RCmUrP0i3FoMIg2Lm0szhu;
        [n1.ElementAttribute(TracingId = 169773U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "CQqRzb7wcPmNbz0Rw9eESo", Name = "Sampler State")]
        public n3.SamplerState Sampler_State;
        [n1.ElementAttribute(TracingId = 169778U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "LVLqrC7VcqlLL4texjGakl", Name = "Mutable Pipeline State")]
        public n3.MutablePipelineState Mutable_Pipeline_State;
        [n1.ElementAttribute(TracingId = 169875U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "QqdSBl6iaj8QNaSOSbjbDz", Name = "Topology")]
        public n3.PrimitiveType Topology;
        [n1.ElementAttribute(TracingId = 169881U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "V0MFYwh4a6KOLPRyWZXDmE", Name = "Buffers")]
        public n3.Buffer[] Buffers;
        [n1.ElementAttribute(TracingId = 169983U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "RlAy2S0iydJQC2LSOJRpYa", Name = "Instance Count")]
        public int Instance_Count;
        [n1.ElementAttribute(TracingId = 169879U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "NSotyrthTKnLV6txgPHw3Y", Name = "Effect")]
        public n10.IEffect Effect;
        [n1.ElementAttribute(TracingId = 169900U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "EJsPsVwiyG1PjQM0gXqj4H", Name = "FromValue", IsManaged = true, IsAutoGenerated = true)]
        public n11.FromValue_OH4TKYsSUseQU3JpOZF4kZ<n3.Buffer> __p_EJsPsVwiyG1PjQM0gXqj4H;
        [n1.ElementAttribute(TracingId = 169990U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "G90yNPVlSvXMV1azhcbDyL", Name = "GameProvider", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 170118U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "VPD0Bjs7T2mNWOzwXPAy9U", Name = "StreamOutModelComponent_C")]
    [n2.SerializableAttribute]
    public class StreamOutModelComponent_C : n1.VLObject, n2.IDisposable
    {
        ...
        public n4.StreamOutModelComponent_C __Create__(n1.NodeContext Node_Context)
        {
            ...
            n1.NodeContext Node_Context_9 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "AGYHMFIS2KsM6zK1T633l6", 170266U);
            ...
            n1.NodeContext Node_Context_13 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "L9BtQwjlQnLODBpFCPGRhk", 170189U);
            ...
            n1.NodeContext Node_Context_28 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "IxZU8QPZiGiL8n6KaugRBg", 170252U);
            ...
            n1.NodeContext Node_Context_38 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "Mnh4j6eKyvJQEYbELchA01", 170254U);
        ...
        [n1.ElementAttribute(TracingId = 170200U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Azh6byGCH3CMusKzaPT5xH", Name = "__slot_Azh6byGCH3CMusKzaPT5xH")]
        public static n14.Vector4 __slot_Azh6byGCH3CMusKzaPT5xH = n38._Operations_.CreateDefault();
        [n1.ElementAttribute(TracingId = 170219U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "TZZ70QdUBKvOzR8YTreMy4", Name = "__slot_TZZ70QdUBKvOzR8YTreMy4")]
        public static bool __slot_TZZ70QdUBKvOzR8YTreMy4 = true;
        [n1.ElementAttribute(TracingId = 170138U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "ARaB6BEgXscMTloXTncahS", Name = "Component")]
        public n12.ModelComponent Component;
        [n1.ElementAttribute(TracingId = 170142U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "NmYbtMTACDRMbb326ALQts", Name = "Mesh Draw")]
        public n8.MeshDraw Mesh_Draw;
        [n1.ElementAttribute(TracingId = 170264U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "GzO5fBnEOGnLGhpnHSwc6z", Name = "Model")]
        public n8.Model Model;
        [n1.ElementAttribute(TracingId = 170254U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Mnh4j6eKyvJQEYbELchA01", Name = "Changed", IsManaged = true, IsAutoGenerated = true)]
        public n32.Changed_A8JGbead2bxNdnPybiEqVS<n8.Material> __p_Mnh4j6eKyvJQEYbELchA01;
        [n1.ElementAttribute(TracingId = 170230U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "GECRTieQSGmOPAVChicclB", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n35.Manager<n2.ValueTuple<n14.BoundingBox>, n2.ValueTuple> __cache_GECRTieQSGmOPAVChicclB = null;
        [n1.ElementAttribute(TracingId = 170266U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "AGYHMFIS2KsM6zK1T633l6", Name = "ComponentManager", IsManaged = true, IsAutoGenerated = true)]
        public n40.ComponentManager_Mp1an8YjRmjLSMhA4AMi5G __p_AGYHMFIS2KsM6zK1T633l6;
        [n1.ElementAttribute(TracingId = 170189U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "L9BtQwjlQnLODBpFCPGRhk", Name = "DynamicBuffer", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 170252U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "IxZU8QPZiGiL8n6KaugRBg", Name = "Pos4", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 170356U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "DbyCuy9U0UpK95gjQWxDXj", Name = "StreamOutInstancer2_DbyCuy9U0UpK95gjQWxDXj")]
    [n2.SerializableAttribute]
    public class StreamOutInstancer2_DbyCuy9U0UpK95gjQWxDXj<T> : n1.VLObject, n2.IDisposable
    {
            ...
            where AdM : struct, n5.IAdaptiveCreateDefault<T[]>
        {
            n25.RuntimeHelpers.EnsureSufficientExecutionStack();
            var w_0 = default(AdM);
            n1.NodeContext Node_Context_1 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "QsYhAUS9JYZP4WSsMGDd1u", 170543U);
            ...
            n1.NodeContext Node_Context_5 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "CSKVBOXUoHsPUjBEim88jG", 170550U);
            ...
            n1.NodeContext Node_Context_13 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "OtgASnr4P7xL980xzAxSsd", 170359U);
            var Output_14 = n28.DynamicBuffer_C82b44KM7nmOgoP82JqMWO<T[]>.Create(Node_Context: Node_Context_13);
            n1.NodeContext Node_Context_15 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "OX8jqbpLVdUO6oVHPxpmMg", 170374U);
            var Output_16 = n28.ComputeBuffer_DmEfvnY9LhgL0IgudEOxyM.Create(Node_Context: Node_Context_15);
            n1.NodeContext Node_Context_17 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "LAemX8Ltd3ALIo1J4kzo6J", 170383U);
            ...
            n1.NodeContext Node_Context_20 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "TsPWqq3MVTLO8B4jftYgHT", 170401U);
            var Output_21 = n4.MeshDrawerStreamOut_C.Create(Node_Context: Node_Context_20);
            n1.NodeContext Node_Context_22 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "ShjgkOdE4vSP0BDWFaImFs", 170408U);
            var Output_23 = n31.Pos3Norm3Tang4Tex2_QolmucOYvm9NopK4AAzv3i.Create(Node_Context: Node_Context_22);
            n1.NodeContext Node_Context_24 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "KuI20UGqPB9MNyF9PlIhLk", 170417U);
            ...
            n1.NodeContext Node_Context_27 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "DuKIFJLNkFXPnCS1GBdcDi", 170425U);
            ...
            n1.NodeContext Node_Context_29 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "ScxsV06h0M2LNDimZK2lXE", 170497U);
            ...
            n1.NodeContext Node_Context_32 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "PQditynQexDPdZfDCXIhqO", 170502U);
            ...
            n1.NodeContext Node_Context_35 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "F6EkCoqDBFANn20vbYkbxb", 170506U);
            ...
            n1.NodeContext Node_Context_38 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "KalBKYkNIBLLY6odbO55DN", 170513U);
            var Output_39 = n32.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_38);
            n1.NodeContext Node_Context_40 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "RDML4rFTwsNMnUE1PDAQSX", 170521U);
            ...
            n1.NodeContext Node_Context_43 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "JHeOgwxsg2LP4NqshXKUsz", 171243U);
            var Output_44 = n31.Pos3Norm3Tex2_T5nlQ9NTaLdQAGRzwKUdRc.Create(Node_Context: Node_Context_43);
            n1.NodeContext Node_Context_45 = Node_Context.CreateSubContext("NL6SEAZgmRHQPFCm3uYN3A", "J953BWVPZphLnP0BWUOe2j", 171250U);
        ...
        [n1.ElementAttribute(TracingId = 170396U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "CsAPIP1I7LDLMIB4eccBcU", Name = "__slot_CsAPIP1I7LDLMIB4eccBcU")]
        ...
        [n1.ElementAttribute(TracingId = 170410U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "EM4sN253hiyN9g8PzQh2A3", Name = "__slot_EM4sN253hiyN9g8PzQh2A3")]
        public static string __slot_EM4sN253hiyN9g8PzQh2A3 = "transformation buffer";
        [n1.ElementAttribute(TracingId = 170411U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "HE6dkA7X1UpPh2iUwZckuY", Name = "__slot_HE6dkA7X1UpPh2iUwZckuY")]
        public static string __slot_HE6dkA7X1UpPh2iUwZckuY = "geometry shader";
        [n1.ElementAttribute(TracingId = 170412U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "FbfS0npuav7LLcWpDgl1Uj", Name = "__slot_FbfS0npuav7LLcWpDgl1Uj")]
        public static string __slot_FbfS0npuav7LLcWpDgl1Uj = "stream out draw call";
        [n1.ElementAttribute(TracingId = 170520U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "Sbk4MdEg1gSP7ce6fGHKVL", Name = "__slot_Sbk4MdEg1gSP7ce6fGHKVL")]
        public n14.Vector3 __slot_Sbk4MdEg1gSP7ce6fGHKVL;
        [n1.ElementAttribute(TracingId = 170542U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "VJhdixHM1rXL5HQ3uUciMg", Name = "__slot_VJhdixHM1rXL5HQ3uUciMg")]
        ...
        [n1.ElementAttribute(TracingId = 171262U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "AqodGclsRGbN38cJZtHgSK", Name = "__slot_AqodGclsRGbN38cJZtHgSK")]
        public static bool __slot_AqodGclsRGbN38cJZtHgSK = true;
        [n1.ElementAttribute(TracingId = 171241U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "BN2aDIPm6QHP1WzXUYFLEx", Name = "Components")]
        public n23.Spread<n12.EntityComponent> Components;
        [n1.ElementAttribute(IsManaged = true, IsAutoGenerated = true)]
        public n2.Object __if_TDcxKfEudH2OIFoAn6wnUA;
        [n1.ElementAttribute(TracingId = 170383U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "LAemX8Ltd3ALIo1J4kzo6J", Name = "AnalyzeMesh", IsManaged = true, IsAutoGenerated = true)]
        public n4.AnalyzeMesh_Jeoc7D9B7h9PBUqptKAvLO __p_LAemX8Ltd3ALIo1J4kzo6J;
        [n1.ElementAttribute(TracingId = 170408U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "ShjgkOdE4vSP0BDWFaImFs", Name = "Pos3Norm3Tang4Tex2", IsManaged = true, IsAutoGenerated = true)]
        public n31.Pos3Norm3Tang4Tex2_QolmucOYvm9NopK4AAzv3i __p_ShjgkOdE4vSP0BDWFaImFs;
        [n1.ElementAttribute(TracingId = 170374U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "OX8jqbpLVdUO6oVHPxpmMg", Name = "ComputeBuffer", IsManaged = true, IsAutoGenerated = true)]
        public n28.ComputeBuffer_DmEfvnY9LhgL0IgudEOxyM __p_OX8jqbpLVdUO6oVHPxpmMg;
        [n1.ElementAttribute(TracingId = 170359U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "OtgASnr4P7xL980xzAxSsd", Name = "DynamicBuffer", IsManaged = true, IsAutoGenerated = true)]
        public n28.DynamicBuffer_C82b44KM7nmOgoP82JqMWO<T[]> __p_OtgASnr4P7xL980xzAxSsd;
        [n1.ElementAttribute(TracingId = 170397U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "KyTnWRPsGHSOlA9cO9Y9cb", Name = "InstancedMeshStreamOutShader", IsManaged = true, IsAutoGenerated = true, NodeName = "InstancedMeshStreamOutShader", NodeCategory = "Stride.Rendering.DrawShaders")]
        public n1.IVLNode __p_KyTnWRPsGHSOlA9cO9Y9cb;
        [n1.ElementAttribute(TracingId = 171258U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "LPpXMZXReOhPZ7WT93JHvb", Name = "InstancedMeshTangentStreamOutShader", IsManaged = true, IsAutoGenerated = true, NodeName = "InstancedMeshTangentStreamOutShader", NodeCategory = "Stride.Rendering.DrawShaders")]
        public n1.IVLNode __p_LPpXMZXReOhPZ7WT93JHvb;
        [n1.ElementAttribute(TracingId = 170401U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "TsPWqq3MVTLO8B4jftYgHT", Name = "MeshDrawerStreamOut", IsManaged = true, IsAutoGenerated = true)]
        public n4.MeshDrawerStreamOut_C __p_TsPWqq3MVTLO8B4jftYgHT;
        [n1.ElementAttribute(TracingId = 170543U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "QsYhAUS9JYZP4WSsMGDd1u", Name = "RenderComponent", IsManaged = true, IsAutoGenerated = true)]
        public n29.RenderComponent_LYdoKoeCq7MPXOIsyysl4d __p_QsYhAUS9JYZP4WSsMGDd1u;
        [n1.ElementAttribute(TracingId = 171250U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "J953BWVPZphLnP0BWUOe2j", Name = "FrameDelay", IsManaged = true, IsAutoGenerated = true)]
        public n32.FrameDelay_VYPkCl1PIexL9IROxeL6ju<bool> __p_J953BWVPZphLnP0BWUOe2j;
        [n1.ElementAttribute(TracingId = 171243U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "JHeOgwxsg2LP4NqshXKUsz", Name = "Pos3Norm3Tex2", IsManaged = true, IsAutoGenerated = true)]
        public n31.Pos3Norm3Tex2_T5nlQ9NTaLdQAGRzwKUdRc __p_JHeOgwxsg2LP4NqshXKUsz;
        [n1.ElementAttribute(TracingId = 170417U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "KuI20UGqPB9MNyF9PlIhLk", Name = "FrameDelay", IsManaged = true, IsAutoGenerated = true)]
        public n32.FrameDelay_VYPkCl1PIexL9IROxeL6ju<int> __p_KuI20UGqPB9MNyF9PlIhLk;
        [n1.ElementAttribute(TracingId = 170550U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "CSKVBOXUoHsPUjBEim88jG", Name = "StreamOutModelComponent", IsManaged = true, IsAutoGenerated = true)]
        public n4.StreamOutModelComponent_C __p_CSKVBOXUoHsPUjBEim88jG;
        [n1.ElementAttribute(TracingId = 170521U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "RDML4rFTwsNMnUE1PDAQSX", Name = "FrameDelay", IsManaged = true, IsAutoGenerated = true)]
        public n32.FrameDelay_VYPkCl1PIexL9IROxeL6ju<bool> __p_RDML4rFTwsNMnUE1PDAQSX;
        [n1.ElementAttribute(TracingId = 170425U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "DuKIFJLNkFXPnCS1GBdcDi", Name = "AsyncTask", IsManaged = true, IsAutoGenerated = true)]
        public n20.AsyncTask<n14.BoundingBox> __p_DuKIFJLNkFXPnCS1GBdcDi;
        [n1.ElementAttribute(TracingId = 170497U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "ScxsV06h0M2LNDimZK2lXE", Name = "HoldLatest", IsManaged = true, IsAutoGenerated = true)]
        public n20.HoldLatest<n14.BoundingBox> __p_ScxsV06h0M2LNDimZK2lXE;
        [n1.ElementAttribute(TracingId = 170502U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "PQditynQexDPdZfDCXIhqO", Name = "Changed", IsManaged = true, IsAutoGenerated = true)]
        public n32.Changed_A8JGbead2bxNdnPybiEqVS<T[]> __p_PQditynQexDPdZfDCXIhqO;
        [n1.ElementAttribute(TracingId = 170506U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "F6EkCoqDBFANn20vbYkbxb", Name = "MonoFlop", IsManaged = true, IsAutoGenerated = true)]
        public n32.MonoFlop_GeOV3KtNF5BPYMkYFPPAst __p_F6EkCoqDBFANn20vbYkbxb;
        [n1.ElementAttribute(TracingId = 170513U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "KalBKYkNIBLLY6odbO55DN", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        ...
        public class __Kb5Zq1RmMspMmwLIwNTMm0 : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 170531U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "LdF0mSWmmuUP56ZjBqNAmR", Name = "BoxMesh", IsManaged = true, IsAutoGenerated = true, NodeName = "BoxMesh", NodeCategory = "Stride.Models.Meshes")]
        ...
        public class __M6K98CKvlVyP0gGZMNPVF4 : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 170490U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "RzkUcd3rCb9NU1LDI6jSZR", Name = "__slot_RzkUcd3rCb9NU1LDI6jSZR")]
    ...
    [n1.ElementAttribute(TracingId = 171428U, DocumentId = "NL6SEAZgmRHQPFCm3uYN3A", PersistentId = "RiqvYTxBGhJPNWSeOu26U2", Name = "VL_Stride_Rendering_InstancerApplication_RiqvYTxBGhJPNWSeOu26U2")]
    [n2.SerializableAttribute]
