...
using n22 = _CoreLibBasics_.Animation.FrameBased;
using n25 = _VL_Cameras_.Editors._3D.Experimental;
...
using n29 = _CoreLibBasics_._3D.Transform;
using n23 = _CoreLibBasics_.Animation.IClock.Advanced;
...
using n36 = e3::VL.Lib.Primitive;
using n13 = _CoreLibBasics_.Math.Ranges.Generic.Advanced;
using n14 = e3::VL.Lib.Mathematics;
using n21 = _VL_Skia_.IO.Keyboard;
using n31 = _VL_Cameras_.Editors;
using n27 = _CoreLibBasics_.IO.Mouse.MouseDevice.Advanced;
using n1 = e2::VL.Core;
using n28 = _CoreLibBasics_.IO.Keyboard.KeyboardDevice.Advanced;
...
using n26 = _VL_Cameras_.Editors._3D.Advanced.Experimental;
using n24 = e2::VL.Lib.Animation;
using n8 = global::System.Runtime.CompilerServices;
using n20 = _VL_Skia_.IO.Mouse;
using n7 = e5::VL.Lib.IO;
using n34 = _CoreLibBasics_.Primitive.Advanced;
using n30 = _CoreLibBasics_._3D.Vector3;

namespace _VL_Cameras_.Editors._2D
{
    [n1.ElementAttribute(TracingId = 40383U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "GadqeOmYZGTMzLKYmkE26a", Name = "Camera_Flat_GadqeOmYZGTMzLKYmkE26a")]
    ...
    public class Camera_Flat_GadqeOmYZGTMzLKYmkE26a : n1.VLObject, n2.IDisposable
    {
        ...
        public n3.Camera_Flat_GadqeOmYZGTMzLKYmkE26a __Create__(n1.NodeContext Node_Context)
        {
            ...
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "IPspk1vRq3ALWDApHdrTrp", 40388U);
            var Output_1 = n5.Camera_LFaaf0fqmTzNy23KpgvNno.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "E33vmiOhGCbMp3xslC6VxR", 40434U);
        ...
        [n1.ElementAttribute(TracingId = 40429U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "VM68IntDTt8O64aQOSFJC8", Name = "__slot_VM68IntDTt8O64aQOSFJC8")]
        public static bool __slot_VM68IntDTt8O64aQOSFJC8 = true;
        [n1.ElementAttribute(TracingId = 40434U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "E33vmiOhGCbMp3xslC6VxR", Name = "FlatCameraControls", IsManaged = true, IsAutoGenerated = true)]
        public n5.FlatCameraControls_A4gAuKiKvazMyBQuk926iQ __p_E33vmiOhGCbMp3xslC6VxR;
        [n1.ElementAttribute(TracingId = 40388U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "IPspk1vRq3ALWDApHdrTrp", Name = "Camera", IsManaged = true, IsAutoGenerated = true)]
...
{
    [n1.ElementAttribute(TracingId = 41949U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "LFaaf0fqmTzNy23KpgvNno", Name = "Camera_LFaaf0fqmTzNy23KpgvNno")]
    [n2.SerializableAttribute]
    public class Camera_LFaaf0fqmTzNy23KpgvNno : n1.VLObject, n2.IDisposable
    {
        ...
        public n5.Camera_LFaaf0fqmTzNy23KpgvNno __Create__(n1.NodeContext Node_Context)
        {
            ...
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Tvqyf2zdZbXPDdiuviNIm3", 48751U);
            var Output_5 = n16.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_4);
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "IByC01h1YlrN7WsJsYqvVp", 48757U);
        ...
        [n1.ElementAttribute(TracingId = 41953U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DRaUg3A7NoWMtmpyX4fNGy", Name = "Transformation")]
        public n6.Matrix Transformation;
        [n1.ElementAttribute(TracingId = 41955U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "CiIbjuINqxiPygJu99hoUC", Name = "Initialize")]
        public bool Initialize;
        [n1.ElementAttribute(TracingId = 41958U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Jd2QwdaQlVZQXrjYj4p4up", Name = "__slot_Jd2QwdaQlVZQXrjYj4p4up")]
        public static float __slot_Jd2QwdaQlVZQXrjYj4p4up = 1F;
        [n1.ElementAttribute(TracingId = 41963U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DtJrxuoQdYLLfRw0qNGuOu", Name = "__slot_DtJrxuoQdYLLfRw0qNGuOu")]
        public static bool __slot_DtJrxuoQdYLLfRw0qNGuOu = false;
        [n1.ElementAttribute(TracingId = 41965U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "MHkCPuD93uAM4ERH5jjH4l", Name = "__slot_MHkCPuD93uAM4ERH5jjH4l")]
        public static bool __slot_MHkCPuD93uAM4ERH5jjH4l = true;
        [n1.ElementAttribute(TracingId = 48836U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Fk87pqbkHMzLNXPWbRedyG", Name = "__slot_Fk87pqbkHMzLNXPWbRedyG")]
        public float __slot_Fk87pqbkHMzLNXPWbRedyG;
        [n1.ElementAttribute(TracingId = 48757U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "IByC01h1YlrN7WsJsYqvVp", Name = "Toggle", IsManaged = true, IsAutoGenerated = true)]
        public n16.Toggle_NRtjXBFlZv8LkW1dAEOgnz __p_IByC01h1YlrN7WsJsYqvVp;
        [n1.ElementAttribute(TracingId = 48751U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Tvqyf2zdZbXPDdiuviNIm3", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 49018U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "RIFycJh98RsNTwGupKrcVf", Name = "CameraControls_R")]
    [n2.SerializableAttribute]
    public class CameraControls_R : n1.VLObject, n2.IDisposable
    {
        ...
        [n1.ElementAttribute(TracingId = 49023U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TUEMPvsHNwPN81tV6qvE8e", Name = "Pan Delta")]
        public n6.Vector2 Pan_Delta;
        [n1.ElementAttribute(TracingId = 49024U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "HeuzLkrCCHxOUJ2DVsYTD9", Name = "Zoom Delta")]
        public float Zoom_Delta;
        [n1.ElementAttribute(TracingId = 49026U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "G0alAJzcadsOgJQ0fxzWh2", Name = "Zoom Target")]
        public n6.Vector2 Zoom_Target;
        [n1.ElementAttribute(TracingId = 49027U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TAseukD8Xr3P3b7r0JzyJ2", Name = "Reset")]
        public bool Reset;
        [n1.ElementAttribute(TracingId = 49029U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "P2i7ZvNMXKzOlIJEhDOjZy", Name = "Not Idle")]
    ...
    [n1.ElementAttribute(TracingId = 53713U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "LoFN5ZaM9SYOwk6ntuwxnm", Name = "CameraState_R")]
    [n2.SerializableAttribute]
    public class CameraState_R : n1.VLObject, n2.IDisposable
    {
        ...
        [n1.ElementAttribute(TracingId = 53717U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "PL4xoskVjAlPxqDzoEYpVG", Name = "View")]
        public n6.Matrix View;
        [n1.ElementAttribute(TracingId = 53719U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "GwbNxZ6GW5ZQRsB2Z98CNt", Name = "Inverse View")]
        public n6.Matrix Inverse_View;
        [n1.ElementAttribute(TracingId = 53721U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "OW9YSbnQ27ZMcipIT0qH45", Name = "Zoom")]
        public float Zoom;
        [n1.ElementAttribute(TracingId = 53723U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SlIKZ2n3zFHNKcj8k4m4sq", Name = "Not Idle")]
        public bool Not_Idle;
        [n1.ElementAttribute(TracingId = 53801U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "I5LX2NJRGscONimG29ilBK", Name = "Renderer Not Hovered")]
    ...
    [n1.ElementAttribute(TracingId = 55282U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "A4gAuKiKvazMyBQuk926iQ", Name = "FlatCameraControls_A4gAuKiKvazMyBQuk926iQ")]
    [n2.SerializableAttribute]
    public class FlatCameraControls_A4gAuKiKvazMyBQuk926iQ : n1.VLObject, n2.IDisposable
    {
        ...
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "KtMlSmEl91kNwO2Ppdnleh", 55362U);
            var Output_1 = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "KuGKS78x6lQNjAr6eRI6U2", 55398U);
            var Output_3 = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.Create(Node_Context: Node_Context_2);
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "C2APHgdy3QEN9830kW5hrb", 55409U);
            var Output_5 = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2>.Create<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>(Node_Context: Node_Context_4);
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "UwGBk0Vit7KPrWbi4IWtxd", 55426U);
            var Output_7 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_6);
            n1.NodeContext Node_Context_8 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "QvFPIGTyKoTPRfK2UqHepK", 55518U);
            var Output_9 = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int>.Create<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>(Node_Context: Node_Context_8);
            n1.NodeContext Node_Context_10 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "T1C8k1u3XWSNr7UBEpfmz6", 55548U);
            n24.IClock Clock_11 = n23._Operations_.CreateDefault();
            var Output_12 = n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H.Create(Node_Context: Node_Context_10, Clock_In: Clock_11);
            n1.NodeContext Node_Context_13 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "NsBC97mGrGZNnsqRkdd6qf", 55569U);
            var Output_14 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_13);
            n1.NodeContext Node_Context_15 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "VayzprCSIFAN5ieBOg6yTk", 55587U);
            var Output_16 = n16.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_15);
            n1.NodeContext Node_Context_17 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "HI9qYZgSJgRQRBH0NQqpC2", 55675U);
        ...
        public n5.FlatCameraControls_A4gAuKiKvazMyBQuk926iQ __CreateDefault__()
        {
            ...
            this.__p_KtMlSmEl91kNwO2Ppdnleh = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.CreateDefault();
            this.__p_C2APHgdy3QEN9830kW5hrb = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2>.CreateDefault<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>();
            this.__p_KuGKS78x6lQNjAr6eRI6U2 = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.CreateDefault();
            this.__p_UwGBk0Vit7KPrWbi4IWtxd = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            this.__p_QvFPIGTyKoTPRfK2UqHepK = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int>.CreateDefault<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>();
            this.__p_NsBC97mGrGZNnsqRkdd6qf = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
        ...
        [n1.ElementAttribute(TracingId = 55327U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "P9gb0517Bm2PqZAFq0KdGM", Name = "__slot_P9gb0517Bm2PqZAFq0KdGM")]
        public static string __slot_P9gb0517Bm2PqZAFq0KdGM = "ShiftKey";
        [n1.ElementAttribute(TracingId = 55337U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Ox8W99D2VcPPS08Aip6Wor", Name = "__slot_Ox8W99D2VcPPS08Aip6Wor")]
        public static float __slot_Ox8W99D2VcPPS08Aip6Wor = 4F;
        [n1.ElementAttribute(TracingId = 55344U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SBsFD0vkXinPb5rsXitmeB", Name = "__slot_SBsFD0vkXinPb5rsXitmeB")]
        public static float __slot_SBsFD0vkXinPb5rsXitmeB = 10F;
        [n1.ElementAttribute(TracingId = 55349U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "AZ90K44eA6wQTYewMtX6cQ", Name = "__slot_AZ90K44eA6wQTYewMtX6cQ")]
        public static string __slot_AZ90K44eA6wQTYewMtX6cQ = "R";
        [n1.ElementAttribute(TracingId = 55356U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "HF38keQo17wLapVoU9TM3h", Name = "__slot_HF38keQo17wLapVoU9TM3h")]
        public static float __slot_HF38keQo17wLapVoU9TM3h = 0.5F;
        [n1.ElementAttribute(TracingId = 55362U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KtMlSmEl91kNwO2Ppdnleh", Name = "MouseState", IsManaged = true, IsAutoGenerated = true)]
        public n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_KtMlSmEl91kNwO2Ppdnleh;
        [n1.ElementAttribute(TracingId = 55409U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "C2APHgdy3QEN9830kW5hrb", Name = "FrameDifference", IsManaged = true, IsAutoGenerated = true)]
        public n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2> __p_C2APHgdy3QEN9830kW5hrb;
        [n1.ElementAttribute(TracingId = 55398U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KuGKS78x6lQNjAr6eRI6U2", Name = "KeyboardState", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_KuGKS78x6lQNjAr6eRI6U2;
        [n1.ElementAttribute(TracingId = 55426U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "UwGBk0Vit7KPrWbi4IWtxd", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_UwGBk0Vit7KPrWbi4IWtxd;
        [n1.ElementAttribute(TracingId = 55518U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "QvFPIGTyKoTPRfK2UqHepK", Name = "FrameDifference", IsManaged = true, IsAutoGenerated = true)]
        public n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int> __p_QvFPIGTyKoTPRfK2UqHepK;
        [n1.ElementAttribute(TracingId = 55569U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "NsBC97mGrGZNnsqRkdd6qf", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_NsBC97mGrGZNnsqRkdd6qf;
        [n1.ElementAttribute(TracingId = 55548U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "T1C8k1u3XWSNr7UBEpfmz6", Name = "TimerFlop", IsManaged = true, IsAutoGenerated = true)]
        public n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H __p_T1C8k1u3XWSNr7UBEpfmz6;
        [n1.ElementAttribute(TracingId = 55587U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "VayzprCSIFAN5ieBOg6yTk", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        public n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_VayzprCSIFAN5ieBOg6yTk;
        [n1.ElementAttribute(TracingId = 55675U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "HI9qYZgSJgRQRBH0NQqpC2", Name = "Changed", IsManaged = true, IsAutoGenerated = true)]
        ...
        internal FlatCameraControls_A4gAuKiKvazMyBQuk926iQ __WITH__(n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_KtMlSmEl91kNwO2Ppdnleh, n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2> __p_C2APHgdy3QEN9830kW5hrb, n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_KuGKS78x6lQNjAr6eRI6U2, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_UwGBk0Vit7KPrWbi4IWtxd, n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int> __p_QvFPIGTyKoTPRfK2UqHepK, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_NsBC97mGrGZNnsqRkdd6qf, n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H __p_T1C8k1u3XWSNr7UBEpfmz6, n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_VayzprCSIFAN5ieBOg6yTk, n16.Changed_A8JGbead2bxNdnPybiEqVS<int> __p_HI9qYZgSJgRQRBH0NQqpC2)
        {
            n5.FlatCameraControls_A4gAuKiKvazMyBQuk926iQ that_0 = this;
            if (this.__GetContext__().IsImmutable)
...
{
    [n1.ElementAttribute(TracingId = 55827U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "E9tsLZ1ZljYQQZibZCjHcV", Name = "Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV")]
    [n2.SerializableAttribute]
    public class Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV CreateDefault()
        {
            var instance = new Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV Update(n6.Vector3 Initial_Interest_In, [n4.SerializedDefaultValueAttribute("1", false)] float Initial_Yaw_In, float Initial_Pitch_In, float Initial_Distance_In, float Initial_FOV_In, [n4.SerializedDefaultValueAttribute("0.01", false)] float Near_Plane_In, [n4.SerializedDefaultValueAttribute("100", false)] float Far_Plane_In, out n26.CameraState_R CameraState3d_Out, out object Idle_Out)
        {
            n26.CameraControls_R Camera_Controls_0 = n26.CameraControls_R.CreateDefault();
            n7.IMouse Mouse_Device_1 = n27._Operations_.CreateDefault();
            n7.IKeyboard Keyboard_Device_2 = n28._Operations_.CreateDefault();
            bool Enabled_3 = true;
            var Output_5 = this.__p_RRfIMfWc7HLQOx8N824uNz.Join(Camera_Controls_In: Camera_Controls_0, Mouse_Device_In: Mouse_Device_1, Keyboard_Device_In: Keyboard_Device_2, Enabled_In: Enabled_3, Camera_Controls_Out: out n26.CameraControls_R Camera_Controls_4);
            bool Renderer_Hovered_6 = false;
            bool Reset_7 = false;
            var Output_9 = this.__p_V0Vz3rloeorNm7XgZwfPn9.Update(Initial_Interest_In: Initial_Interest_In, Initial_Longitude_In: Initial_Yaw_In, Initial_Latitude_In: Initial_Pitch_In, Initial_Distance_In: Initial_Distance_In, Initial_FOV_In: Initial_FOV_In, Near_Plane_In: Near_Plane_In, Far_Plane_In: Far_Plane_In, CameraControls3d_In: Camera_Controls_4, Renderer_Hovered_In: Renderer_Hovered_6, Reset_In: Reset_7, CameraState3d_Out: out n26.CameraState_R CameraState3d_8);
            CameraState3d_Out = CameraState3d_8;
            Idle_Out = default(object);
            n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV that_10 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "V0Vz3rloeorNm7XgZwfPn9", 56346U);
            var Output_1 = n26.Camera_HKLB3PgmAVIMC1vhgpaagj.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "RRfIMfWc7HLQOx8N824uNz", 56374U);
            var Output_3 = n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W.Create(Node_Context: Node_Context_2);
            n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV that_4 = this;
            this.__p_V0Vz3rloeorNm7XgZwfPn9 = Output_1;
            this.__p_RRfIMfWc7HLQOx8N824uNz = Output_3;
            return that_4;
        }

        public n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV __CreateDefault__()
        {
            n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV that_0 = this;
            this.__p_RRfIMfWc7HLQOx8N824uNz = n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W.CreateDefault();
            this.__p_V0Vz3rloeorNm7XgZwfPn9 = n26.Camera_HKLB3PgmAVIMC1vhgpaagj.CreateDefault();
            return that_0;
        }
        ...
        [n1.ElementAttribute(TracingId = 56341U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KIun6koWmegLoz5ftBhVC1", Name = "__slot_KIun6koWmegLoz5ftBhVC1")]
        public static string __slot_KIun6koWmegLoz5ftBhVC1 = "connect mouse and keyboard below";
        [n1.ElementAttribute(TracingId = 56374U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "RRfIMfWc7HLQOx8N824uNz", Name = "SoftimageCameraControls", IsManaged = true, IsAutoGenerated = true)]
        public n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W __p_RRfIMfWc7HLQOx8N824uNz;
        [n1.ElementAttribute(TracingId = 56346U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "V0Vz3rloeorNm7XgZwfPn9", Name = "Camera", IsManaged = true, IsAutoGenerated = true)]
        public n26.Camera_HKLB3PgmAVIMC1vhgpaagj __p_V0Vz3rloeorNm7XgZwfPn9;
        ...
        internal Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV __WITH__(n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W __p_RRfIMfWc7HLQOx8N824uNz, n26.Camera_HKLB3PgmAVIMC1vhgpaagj __p_V0Vz3rloeorNm7XgZwfPn9)
        {
            n25.Camera_Softimage_E9tsLZ1ZljYQQZibZCjHcV that_0 = this;
            if (this.__GetContext__().IsImmutable)
    ...
    [n1.ElementAttribute(TracingId = 56454U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SNtf6GIgOyxLiTq5x6Kk4z", Name = "Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z")]
    [n2.SerializableAttribute]
    public class Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z CreateDefault()
        {
            var instance = new Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z Update(n6.Vector3 Initial_Interest_In, [n4.SerializedDefaultValueAttribute("1", false)] float Initial_Yaw_In, float Initial_Pitch_In, [n4.SerializedDefaultValueAttribute("2", false)] float Initial_Distance_In, [n4.SerializedDefaultValueAttribute("0.12", false)] float Initial_FOV_In, n7.IMouse Mouse_In, n7.IKeyboard Keyboard_In, [n4.SerializedDefaultValueAttribute("0.01", false)] float Near_Plane_In, [n4.SerializedDefaultValueAttribute("100", false)] float Far_Plane_In, out n26.CameraState_R CameraState3d_Out, out bool Idle_Out)
        {
            ...
            n26.CameraControls_R Camera_Controls_2 = n26.CameraControls_R.CreateDefault();
            float Filter_Time_3 = 0.5F;
            bool Enable_Controls_4 = true;
            var Output_6 = this.__p_UcvgKlIBwhuOu0tQmqBPcN.Join(Camera_Controls_In: Camera_Controls_2, Mouse_Device_In: Mouse_In, Keyboard_Device_In: Keyboard_In, Filter_Time_In: Filter_Time_3, Enable_Controls_In: Enable_Controls_4, Camera_Controls_Out: out n26.CameraControls_R Camera_Controls_5);
            bool Renderer_Hovered_7 = false;
            bool Reset_8 = false;
            var Output_10 = this.__p_Rtq4vxmrYZ4PgIKj1bjyAK.Update(Initial_Interest_In: Initial_Interest_In, Initial_Longitude_In: Initial_Yaw_In, Initial_Latitude_In: Initial_Pitch_In, Initial_Distance_In: Initial_Distance_In, Initial_FOV_In: Initial_FOV_In, Near_Plane_In: Near_Plane_In, Far_Plane_In: Far_Plane_In, CameraControls3d_In: Camera_Controls_5, Renderer_Hovered_In: Renderer_Hovered_7, Reset_In: Reset_8, CameraState3d_Out: out n26.CameraState_R CameraState3d_9);
            ...
            Idle_Out = Output_33;
            n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z that_35 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Rtq4vxmrYZ4PgIKj1bjyAK", 56509U);
            var Output_1 = n26.Camera_HKLB3PgmAVIMC1vhgpaagj.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Rlr7Owy6U8bNzey9NPg13y", 56540U);
            var Output_3 = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.Create(Node_Context: Node_Context_2);
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "MML41Xl0MQnMe05vgwn2At", 56568U);
            var Output_5 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_4);
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "AkusTeYJKxELlR7HuYWTA9", 56575U);
            var Output_7 = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.Create(Node_Context: Node_Context_6);
            n1.NodeContext Node_Context_8 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Nq8PdmyVEXpNNR8ip1Wr7b", 56579U);
            var Output_9 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_8);
            n1.NodeContext Node_Context_10 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "UcvgKlIBwhuOu0tQmqBPcN", 56643U);
            var Output_11 = n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3.Create(Node_Context: Node_Context_10);
            n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z that_12 = this;
        ...
        public n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z __CreateDefault__()
        {
            n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z that_0 = this;
            this.__p_UcvgKlIBwhuOu0tQmqBPcN = n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3.CreateDefault();
            this.__p_Rtq4vxmrYZ4PgIKj1bjyAK = n26.Camera_HKLB3PgmAVIMC1vhgpaagj.CreateDefault();
            this.__p_Rlr7Owy6U8bNzey9NPg13y = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.CreateDefault();
            this.__p_AkusTeYJKxELlR7HuYWTA9 = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.CreateDefault();
            this.__p_MML41Xl0MQnMe05vgwn2At = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            this.__p_Nq8PdmyVEXpNNR8ip1Wr7b = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            return that_0;
        }
        ...
        [n1.ElementAttribute(TracingId = 56497U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "T4dvIRbOzoxNrvFNEb4jL5", Name = "__slot_T4dvIRbOzoxNrvFNEb4jL5")]
        public static string __slot_T4dvIRbOzoxNrvFNEb4jL5 = "R";
        [n1.ElementAttribute(TracingId = 56502U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SWQ6QmhaoZaMdm3tOGhenG", Name = "__slot_SWQ6QmhaoZaMdm3tOGhenG")]
        public static string __slot_SWQ6QmhaoZaMdm3tOGhenG = "ControlKey";
        [n1.ElementAttribute(TracingId = 56643U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "UcvgKlIBwhuOu0tQmqBPcN", Name = "OrbitCameraControls", IsManaged = true, IsAutoGenerated = true)]
        public n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 __p_UcvgKlIBwhuOu0tQmqBPcN;
        [n1.ElementAttribute(TracingId = 56509U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Rtq4vxmrYZ4PgIKj1bjyAK", Name = "Camera", IsManaged = true, IsAutoGenerated = true)]
        public n26.Camera_HKLB3PgmAVIMC1vhgpaagj __p_Rtq4vxmrYZ4PgIKj1bjyAK;
        [n1.ElementAttribute(TracingId = 56540U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Rlr7Owy6U8bNzey9NPg13y", Name = "MouseState", IsManaged = true, IsAutoGenerated = true)]
        public n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_Rlr7Owy6U8bNzey9NPg13y;
        [n1.ElementAttribute(TracingId = 56575U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "AkusTeYJKxELlR7HuYWTA9", Name = "KeyboardState", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_AkusTeYJKxELlR7HuYWTA9;
        [n1.ElementAttribute(TracingId = 56568U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "MML41Xl0MQnMe05vgwn2At", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_MML41Xl0MQnMe05vgwn2At;
        [n1.ElementAttribute(TracingId = 56579U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Nq8PdmyVEXpNNR8ip1Wr7b", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_Nq8PdmyVEXpNNR8ip1Wr7b;
        ...
        internal Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z __WITH__(n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 __p_UcvgKlIBwhuOu0tQmqBPcN, n26.Camera_HKLB3PgmAVIMC1vhgpaagj __p_Rtq4vxmrYZ4PgIKj1bjyAK, n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_Rlr7Owy6U8bNzey9NPg13y, n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_AkusTeYJKxELlR7HuYWTA9, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_MML41Xl0MQnMe05vgwn2At, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_Nq8PdmyVEXpNNR8ip1Wr7b)
        {
            n25.Camera_Orbit_SNtf6GIgOyxLiTq5x6Kk4z that_0 = this;
            if (this.__GetContext__().IsImmutable)
...
{
    [n1.ElementAttribute(TracingId = 56735U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "HKLB3PgmAVIMC1vhgpaagj", Name = "Camera_HKLB3PgmAVIMC1vhgpaagj")]
    [n2.SerializableAttribute]
    public class Camera_HKLB3PgmAVIMC1vhgpaagj : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n26.Camera_HKLB3PgmAVIMC1vhgpaagj Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n26.Camera_HKLB3PgmAVIMC1vhgpaagj CreateDefault()
        {
            var instance = new Camera_HKLB3PgmAVIMC1vhgpaagj(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n26.Camera_HKLB3PgmAVIMC1vhgpaagj Update(n6.Vector3 Initial_Interest_In, [n4.SerializedDefaultValueAttribute("1", false)] float Initial_Longitude_In, float Initial_Latitude_In, float Initial_Distance_In, float Initial_FOV_In, [n4.SerializedDefaultValueAttribute("0.01", false)] float Near_Plane_In, [n4.SerializedDefaultValueAttribute("100", false)] float Far_Plane_In, n26.CameraControls_R CameraControls3d_In, bool Renderer_Hovered_In, bool Reset_In, out n26.CameraState_R CameraState3d_Out)
        {
            ...
            n29._Operations_.Rotate(Input_In: Input_46, Rotation_In: Output_44, Output_Out: out n6.Matrix Output_47);
            ...
            n6.Vector3 Input_74 = n30._Operations_.CreateDefault();
            ...
            n26.Camera_HKLB3PgmAVIMC1vhgpaagj that_81 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n26.Camera_HKLB3PgmAVIMC1vhgpaagj __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            bool __pad_DG1GIeUrYkJNbBfNEqZAdW_0 = __slot_DG1GIeUrYkJNbBfNEqZAdW;
            bool __auto_1 = __pad_DG1GIeUrYkJNbBfNEqZAdW_0;
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "JWQsAm25TI1NuwYqpL2jnC", 59712U);
            var Output_3 = n16.Toggle_NRtjXBFlZv8LkW1dAEOgnz.Create(Node_Context: Node_Context_2);
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Bmkyq23rBOJPVsbfJmWn6G", 59716U);
            var Output_5 = n16.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_4);
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "LGX4Ibp9NTuPBAOaFVGyiC", 60017U);
            var Output_7 = n26.CameraState_R.Create(Node_Context: Node_Context_6);
            n26.Camera_HKLB3PgmAVIMC1vhgpaagj that_8 = this;
            this.Latitude = 0F;
            this.Longitude = 0F;
            this.FOV = 0F;
            this.Distance = 0F;
            this.Interest = n30._Operations_.CreateDefault();
        ...
        public n26.Camera_HKLB3PgmAVIMC1vhgpaagj __CreateDefault__()
        {
            n26.Camera_HKLB3PgmAVIMC1vhgpaagj that_0 = this;
            this.Latitude = 0F;
            this.Longitude = 0F;
            this.FOV = 0F;
            this.Distance = 0F;
            ...
            this.__p_LGX4Ibp9NTuPBAOaFVGyiC = n26.CameraState_R.CreateDefault();
            return that_0;
        }
        ...
        [n1.ElementAttribute(TracingId = 56737U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Jp6srr5KnAEL7JTbvj39WZ", Name = "Latitude")]
        public float Latitude;
        [n1.ElementAttribute(TracingId = 56738U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "GoPGljsGNXNNStU0jNTBfA", Name = "Longitude")]
        public float Longitude;
        [n1.ElementAttribute(TracingId = 56739U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TcJgTcZet4pLgUkk01QBMz", Name = "FOV")]
        public float FOV;
        [n1.ElementAttribute(TracingId = 56740U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "ReTE7VgiisEOXN7ctVvPOk", Name = "Distance")]
        public float Distance;
        [n1.ElementAttribute(TracingId = 56741U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Juq7oqAWhE8MDwi0KTKtEX", Name = "Interest")]
        public n6.Vector3 Interest;
        [n1.ElementAttribute(TracingId = 56742U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DnlvDp0hMDFMl0HdJ0oLPJ", Name = "Initialize")]
        public bool Initialize;
        [n1.ElementAttribute(TracingId = 57985U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "PRva8n2fu5yNXaMyvvGVSW", Name = "__slot_PRva8n2fu5yNXaMyvvGVSW")]
        public static float __slot_PRva8n2fu5yNXaMyvvGVSW = 1F;
        [n1.ElementAttribute(TracingId = 57993U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DG1GIeUrYkJNbBfNEqZAdW", Name = "__slot_DG1GIeUrYkJNbBfNEqZAdW")]
        public static bool __slot_DG1GIeUrYkJNbBfNEqZAdW = true;
        [n1.ElementAttribute(TracingId = 57999U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Dnp0YxX8fR9OtmME9r82dX", Name = "__slot_Dnp0YxX8fR9OtmME9r82dX")]
        public static bool __slot_Dnp0YxX8fR9OtmME9r82dX = false;
        [n1.ElementAttribute(TracingId = 58002U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "T847zBB3pdgL2gTa14fuVP", Name = "__slot_T847zBB3pdgL2gTa14fuVP")]
        public static float __slot_T847zBB3pdgL2gTa14fuVP = -0.249899909F;
        [n1.ElementAttribute(TracingId = 58014U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "H4zGKI5CXUQLX57hMqe4tJ", Name = "__slot_H4zGKI5CXUQLX57hMqe4tJ")]
        public static float __slot_H4zGKI5CXUQLX57hMqe4tJ = 0.249900028F;
        [n1.ElementAttribute(TracingId = 58024U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "S6sshKGnDIrL0fj18sjaYE", Name = "__slot_S6sshKGnDIrL0fj18sjaYE")]
        public static int __slot_S6sshKGnDIrL0fj18sjaYE = -1;
        [n1.ElementAttribute(TracingId = 58035U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "CXaKQtPvHmiOxb8sxEGeHK", Name = "__slot_CXaKQtPvHmiOxb8sxEGeHK")]
        public static float __slot_CXaKQtPvHmiOxb8sxEGeHK = -1F;
        [n1.ElementAttribute(TracingId = 58044U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "F6xkoKEp24sLCwCRfqYwGc", Name = "__slot_F6xkoKEp24sLCwCRfqYwGc")]
        public static float __slot_F6xkoKEp24sLCwCRfqYwGc = -1F;
        [n1.ElementAttribute(TracingId = 58054U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "E7sSI5WHQxdMo2QuCX3A6J", Name = "__slot_E7sSI5WHQxdMo2QuCX3A6J")]
        public static float __slot_E7sSI5WHQxdMo2QuCX3A6J = -1F;
        [n1.ElementAttribute(TracingId = 58063U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Ah2HubJVE8kNTuryLTji2d", Name = "__slot_Ah2HubJVE8kNTuryLTji2d")]
        public static float __slot_Ah2HubJVE8kNTuryLTji2d = -1F;
        [n1.ElementAttribute(TracingId = 59712U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "JWQsAm25TI1NuwYqpL2jnC", Name = "Toggle", IsManaged = true, IsAutoGenerated = true)]
        public n16.Toggle_NRtjXBFlZv8LkW1dAEOgnz __p_JWQsAm25TI1NuwYqpL2jnC;
        [n1.ElementAttribute(TracingId = 59716U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Bmkyq23rBOJPVsbfJmWn6G", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        public n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_Bmkyq23rBOJPVsbfJmWn6G;
        [n1.ElementAttribute(TracingId = 60017U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "LGX4Ibp9NTuPBAOaFVGyiC", Name = "CameraState", IsManaged = true, IsAutoGenerated = true)]
        public n26.CameraState_R __p_LGX4Ibp9NTuPBAOaFVGyiC;
        ...
        internal Camera_HKLB3PgmAVIMC1vhgpaagj __WITH__(float Latitude, float Longitude, float FOV, float Distance, n6.Vector3 Interest, bool Initialize, n16.Toggle_NRtjXBFlZv8LkW1dAEOgnz __p_JWQsAm25TI1NuwYqpL2jnC, n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_Bmkyq23rBOJPVsbfJmWn6G, n26.CameraState_R __p_LGX4Ibp9NTuPBAOaFVGyiC)
        {
            n26.Camera_HKLB3PgmAVIMC1vhgpaagj that_0 = this;
            if (this.__GetContext__().IsImmutable)
    ...
    [n1.ElementAttribute(TracingId = 60161U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TnZ4T1hma1PPGP2khAxWhw", Name = "CameraControls_R")]
    [n2.SerializableAttribute]
    public class CameraControls_R : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n26.CameraControls_R Create(n1.NodeContext Node_Context)
        {
            Node_Context = Node_Context.WithIsImmutable(true);
            var instance = new CameraControls_R(Node_Context, n1.VLObject.NewIdentity());
            return instance.__Create__(Node_Context);
        ...
        [n4.CreateDefaultAttribute]
        public static n26.CameraControls_R CreateDefault()
        {
            return __DEFAULT__ ?? (__DEFAULT__ = __COMPUTE__());
            n26.CameraControls_R __COMPUTE__()
            {
                var context = n1.NodeContext.Default.WithIsImmutable(true);
                var instance = new CameraControls_R(context, n1.VLObject.NewIdentity());
                return instance.__CreateDefault__();
        ...
        [n1.ElementAttribute(IsAutoGenerated = true)]
        public static n26.CameraControls_R __DEFAULT__;
        public n26.CameraControls_R Join(float Longitude_Delta_In, float Latitude_Delta_In, float FOV_Delta_In, n6.Vector2 Interest_Delta_In, float Distance_Delta_In, bool Reset_In, bool Idle_In)
        {
            ...
            n26.CameraControls_R that_10 = this;
        ...
        public n26.CameraControls_R Split(out float Longitude_Delta_Out, out float Latitude_Delta_Out, out float FOV_Delta_Out, out n6.Vector2 Interest_Delta_Out, out float Distance_Delta_Out, out bool Reset_Out, out bool Idle_Out)
        {
        ...
        public n26.CameraControls_R Combine(float Longitude_Delta_In, float Latitude_Delta_In, float FOV_Delta_In, n6.Vector2 Interest_Delta_In, float Distance_Delta_In, bool Reset_In, [n4.SerializedDefaultValueAttribute("True", false)] bool Idle_In)
        {
            float __auto_0 = this.Longitude_Delta;
            float __auto_1 = this.Latitude_Delta;
            float __auto_2 = this.FOV_Delta;
            ...
            n26.CameraControls_R that_41 = this;
        ...
        public n26.CameraControls_R __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n26.CameraControls_R that_0 = this;
        ...
        public n26.CameraControls_R __CreateDefault__()
        {
            n26.CameraControls_R that_0 = this;
            this.Longitude_Delta = 0F;
            this.Latitude_Delta = 0F;
        ...
        [n1.ElementAttribute(TracingId = 60163U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "V8dWdLIU14jMGbNfEAm5Po", Name = "Longitude Delta")]
        public float Longitude_Delta;
        [n1.ElementAttribute(TracingId = 60164U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "GAkbCT5kMpfN2oS6sUcquR", Name = "Latitude Delta")]
        public float Latitude_Delta;
        [n1.ElementAttribute(TracingId = 60165U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "NlSbbxsrGwLPseprPCkgGH", Name = "FOV Delta")]
        public float FOV_Delta;
        [n1.ElementAttribute(TracingId = 60166U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "CcEJHbs2zCVPqWNRWN1Ws4", Name = "Interest Delta")]
        public n6.Vector2 Interest_Delta;
        [n1.ElementAttribute(TracingId = 60167U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "AbMKOT2krA4MLd8gtw0Pb8", Name = "Distance Delta")]
        public float Distance_Delta;
        [n1.ElementAttribute(TracingId = 60168U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Mg8OmJKocZRM6i7uipROtM", Name = "Reset")]
        public bool Reset;
        [n1.ElementAttribute(TracingId = 60169U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "N7XliBYW10wPlqHR78wO5R", Name = "Not Idle")]
        public bool Not_Idle;
        public CameraControls_R(n1.NodeContext __context__, uint __identity__): base(__context__, __identity__)
        {
        }
    ...
    [n1.ElementAttribute(TracingId = 63549U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "JpFO6ISBkdXLIiLSpG6ZsD", Name = "CameraState_R")]
    [n2.SerializableAttribute]
    public class CameraState_R : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n26.CameraState_R Create(n1.NodeContext Node_Context)
        {
            Node_Context = Node_Context.WithIsImmutable(true);
            var instance = new CameraState_R(Node_Context, n1.VLObject.NewIdentity());
            return instance.__Create__(Node_Context);
        ...
        [n4.CreateDefaultAttribute]
        public static n26.CameraState_R CreateDefault()
        {
            return __DEFAULT__ ?? (__DEFAULT__ = __COMPUTE__());
            n26.CameraState_R __COMPUTE__()
            {
                var context = n1.NodeContext.Default.WithIsImmutable(true);
                var instance = new CameraState_R(context, n1.VLObject.NewIdentity());
                return instance.__CreateDefault__();
        ...
        [n1.ElementAttribute(IsAutoGenerated = true)]
        public static n26.CameraState_R __DEFAULT__;
        public n26.CameraState_R Join(n6.Matrix View_Projection_In, n6.Matrix View_In, n6.Matrix Projection_In, n6.Matrix Inverse_View_In, n6.Vector3 Position_In, n6.Vector3 Interest_In, float FOV_In, float Distance_In, bool Four_Rooms_In, int Active_Viewport_In, bool Renderer_Hovered_In, bool Idle_In)
        {
            ...
            n26.CameraState_R that_18 = this;
        ...
        public n26.CameraState_R __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n26.CameraState_R that_0 = this;
            this.View_Projection = n10._Operations_.CreateDefault();
            this.View = n10._Operations_.CreateDefault();
            this.Projection = n10._Operations_.CreateDefault();
            this.Inverse_View = n10._Operations_.CreateDefault();
            this.Position = n30._Operations_.CreateDefault();
            this.Interest = n30._Operations_.CreateDefault();
            this.FOV = 0F;
            this.Distance = 0F;
        ...
        public n26.CameraState_R __CreateDefault__()
        {
            n26.CameraState_R that_0 = this;
            this.View_Projection = n10._Operations_.CreateDefault();
            this.View = n10._Operations_.CreateDefault();
        ...
        [n1.ElementAttribute(TracingId = 63557U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Nm6OHPCPkNIMwE9nDDocHi", Name = "View Projection")]
        public n6.Matrix View_Projection;
        [n1.ElementAttribute(TracingId = 63563U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "AVxAB1yfdY8PjXx8F2IGFC", Name = "View")]
        public n6.Matrix View;
        [n1.ElementAttribute(TracingId = 63567U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SvSK9yzQvcQLfucLFVSsFz", Name = "Projection")]
        public n6.Matrix Projection;
        [n1.ElementAttribute(TracingId = 63570U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KgC067wusxKOf7tWlTbp4B", Name = "Inverse View")]
        public n6.Matrix Inverse_View;
        [n1.ElementAttribute(TracingId = 63574U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "JdDvD63r1mgP1ROXsLr7xm", Name = "Position")]
        public n6.Vector3 Position;
        [n1.ElementAttribute(TracingId = 63577U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Jys9BFf2HLfMLD3T4hch56", Name = "Interest")]
        public n6.Vector3 Interest;
        [n1.ElementAttribute(TracingId = 63579U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "PWrLaLqG6NnNWNFIW0OPHn", Name = "FOV")]
        public float FOV;
        [n1.ElementAttribute(TracingId = 63583U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TZ9Ou6JZGhqNuYi7xeNIef", Name = "Distance")]
        public float Distance;
        [n1.ElementAttribute(TracingId = 63587U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "CzniDgoJ0zrPnfcQ4Wq0B9", Name = "Four Rooms")]
        public bool Four_Rooms;
        [n1.ElementAttribute(TracingId = 63589U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "HR4Q79v2Oj2OW9a4gyXuCZ", Name = "Active Viewport")]
        public int Active_Viewport;
        [n1.ElementAttribute(TracingId = 63591U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "HRkgbuEMdtPPoym6gCWyzy", Name = "Not Idle")]
        public bool Not_Idle;
        [n1.ElementAttribute(TracingId = 63781U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "LJdASOKAod9LkkZo3raU66", Name = "Renderer Not Hovered")]
        public bool Renderer_Not_Hovered;
        public CameraState_R(n1.NodeContext __context__, uint __identity__): base(__context__, __identity__)
        {
        }
    ...
    [n1.ElementAttribute(TracingId = 64764U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "FBxS20I0dg6Nl63P2ejQR3", Name = "OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3")]
    [n2.SerializableAttribute]
    public class OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 CreateDefault()
        {
            var instance = new OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 Join(n26.CameraControls_R Camera_Controls_In, n7.IMouse Mouse_Device_In, n7.IKeyboard Keyboard_Device_In, [n4.SerializedDefaultValueAttribute("0.5", false)] float Filter_Time_In, [n4.SerializedDefaultValueAttribute("True", false)] bool Enable_Controls_In, out n26.CameraControls_R Camera_Controls_Out)
        {
            ...
            n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 that_89 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "QuUj5N5Nlm3Mw3S9NClxmG", 64969U);
            var Output_1 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "JnkgbH4fHoTQYTAn2zhIC3", 65039U);
            var Output_3 = n16.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_2);
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "TyRkRvr8t7gObGTn74orhh", 65055U);
            var Output_5 = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2>.Create<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>(Node_Context: Node_Context_4);
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "KVV2iJErwuVPVmTmLUPGTE", 65466U);
            n24.IClock Clock_7 = n23._Operations_.CreateDefault();
            var Output_8 = n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H.Create(Node_Context: Node_Context_6, Clock_In: Clock_7);
            n1.NodeContext Node_Context_9 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "LsGSigw0PVVM0T35oaZzgO", 65483U);
            var Output_10 = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int>.Create<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>(Node_Context: Node_Context_9);
            n1.NodeContext Node_Context_11 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "PsaAfzXD84KO93iaIihy7y", 65495U);
            var Output_12 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_11);
            n1.NodeContext Node_Context_13 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "UQOerRAkmh3OHUjhll3ckm", 65536U);
            var Output_14 = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.Create(Node_Context: Node_Context_13);
            n1.NodeContext Node_Context_15 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "ATMlydFu917MUljuR3XEAl", 65541U);
            var Output_16 = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.Create(Node_Context: Node_Context_15);
            n1.NodeContext Node_Context_17 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "POo8Rr6hiVyO7crqq7ZKnu", 65593U);
            float Initial_Position_18 = 0F;
            n24.IFrameClock Clock_19 = n32._Operations_.CreateDefault();
            ...
            n1.NodeContext Node_Context_21 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "DcfTaJYXy5FL6eWvdem4Qs", 65611U);
            float Initial_Position_22 = 0F;
            n24.IFrameClock Clock_23 = n32._Operations_.CreateDefault();
            ...
            n1.NodeContext Node_Context_25 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "A0MNNAUYuFVNyR9vTGNSiB", 65630U);
            float Initial_Position_26 = 0F;
            n24.IFrameClock Clock_27 = n32._Operations_.CreateDefault();
            ...
            n1.NodeContext Node_Context_29 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "DfifmDyccYrLgrP64KFTpP", 65643U);
            float Initial_Position_30 = 0F;
            n24.IFrameClock Clock_31 = n32._Operations_.CreateDefault();
            ...
            n1.NodeContext Node_Context_33 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "TEbOE3hfcbRNYbrCMYW3Of", 65663U);
            n6.Vector2 Initial_Position_34 = n17._Operations_.CreateDefault();
            n24.IFrameClock Clock_35 = n32._Operations_.CreateDefault();
            ...
            n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 that_37 = this;
        ...
        public n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 __CreateDefault__()
        {
            n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 that_0 = this;
            this.__p_ATMlydFu917MUljuR3XEAl = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.CreateDefault();
            this.__p_TyRkRvr8t7gObGTn74orhh = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2>.CreateDefault<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>();
            ...
            this.__p_LsGSigw0PVVM0T35oaZzgO = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int>.CreateDefault<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>();
            this.__p_UQOerRAkmh3OHUjhll3ckm = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.CreateDefault();
            this.__p_QuUj5N5Nlm3Mw3S9NClxmG = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            ...
            this.__p_PsaAfzXD84KO93iaIihy7y = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
        ...
        [n1.ElementAttribute(TracingId = 64824U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "FyJ4msG0ps1LSifruJaJBI", Name = "__slot_FyJ4msG0ps1LSifruJaJBI")]
        public static float __slot_FyJ4msG0ps1LSifruJaJBI = 0.015F;
        [n1.ElementAttribute(TracingId = 64839U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SsaADLCPsW7OwvLHd0r0ct", Name = "__slot_SsaADLCPsW7OwvLHd0r0ct")]
        public static string __slot_SsaADLCPsW7OwvLHd0r0ct = "ControlKey";
        [n1.ElementAttribute(TracingId = 64848U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "O9wa43EqDhpOSn3Oy4Ydtq", Name = "__slot_O9wa43EqDhpOSn3Oy4Ydtq")]
        public static float __slot_O9wa43EqDhpOSn3Oy4Ydtq = 0.5F;
        [n1.ElementAttribute(TracingId = 64858U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "JSmLjEZpIlvMvC5ix3pUqL", Name = "__slot_JSmLjEZpIlvMvC5ix3pUqL")]
        public static string __slot_JSmLjEZpIlvMvC5ix3pUqL = "R";
        [n1.ElementAttribute(TracingId = 65583U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Mj0D14pCRTuMy18vhCNcYy", Name = "__slot_Mj0D14pCRTuMy18vhCNcYy")]
        public static float __slot_Mj0D14pCRTuMy18vhCNcYy = 1.6F;
        [n1.ElementAttribute(TracingId = 65587U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SwUywVIV7t2LH7Pj6Bdwv8", Name = "__slot_SwUywVIV7t2LH7Pj6Bdwv8")]
        public static float __slot_SwUywVIV7t2LH7Pj6Bdwv8 = 0.25F;
        [n1.ElementAttribute(TracingId = 65588U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "U4TmoDSLiWAPnaR56rMqWL", Name = "__slot_U4TmoDSLiWAPnaR56rMqWL")]
        public static float __slot_U4TmoDSLiWAPnaR56rMqWL = 1F;
        [n1.ElementAttribute(TracingId = 65589U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DPkH5LjwjPRNaYPlCPOFKM", Name = "__slot_DPkH5LjwjPRNaYPlCPOFKM")]
        public static string __slot_DPkH5LjwjPRNaYPlCPOFKM = "SPEEDS";
        [n1.ElementAttribute(TracingId = 65541U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "ATMlydFu917MUljuR3XEAl", Name = "MouseState", IsManaged = true, IsAutoGenerated = true)]
        public n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_ATMlydFu917MUljuR3XEAl;
        [n1.ElementAttribute(TracingId = 65055U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TyRkRvr8t7gObGTn74orhh", Name = "FrameDifference", IsManaged = true, IsAutoGenerated = true)]
        public n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2> __p_TyRkRvr8t7gObGTn74orhh;
        [n1.ElementAttribute(TracingId = 65593U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "POo8Rr6hiVyO7crqq7ZKnu", Name = "Filter", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 65611U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DcfTaJYXy5FL6eWvdem4Qs", Name = "Filter", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 65483U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "LsGSigw0PVVM0T35oaZzgO", Name = "FrameDifference", IsManaged = true, IsAutoGenerated = true)]
        public n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int> __p_LsGSigw0PVVM0T35oaZzgO;
        [n1.ElementAttribute(TracingId = 65536U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "UQOerRAkmh3OHUjhll3ckm", Name = "KeyboardState", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_UQOerRAkmh3OHUjhll3ckm;
        [n1.ElementAttribute(TracingId = 64969U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "QuUj5N5Nlm3Mw3S9NClxmG", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_QuUj5N5Nlm3Mw3S9NClxmG;
        [n1.ElementAttribute(TracingId = 65630U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "A0MNNAUYuFVNyR9vTGNSiB", Name = "Filter", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 65663U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "TEbOE3hfcbRNYbrCMYW3Of", Name = "Filter", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 65643U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DfifmDyccYrLgrP64KFTpP", Name = "Filter", IsManaged = true, IsAutoGenerated = true)]
        ...
        [n1.ElementAttribute(TracingId = 65495U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "PsaAfzXD84KO93iaIihy7y", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_PsaAfzXD84KO93iaIihy7y;
        [n1.ElementAttribute(TracingId = 65466U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KVV2iJErwuVPVmTmLUPGTE", Name = "TimerFlop", IsManaged = true, IsAutoGenerated = true)]
        public n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H __p_KVV2iJErwuVPVmTmLUPGTE;
        [n1.ElementAttribute(TracingId = 65039U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "JnkgbH4fHoTQYTAn2zhIC3", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        ...
        internal OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 __WITH__(n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_ATMlydFu917MUljuR3XEAl, n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2> __p_TyRkRvr8t7gObGTn74orhh, n33.Filter_APkUExWKTIiNJbZIcf8Uew<float> __p_POo8Rr6hiVyO7crqq7ZKnu, n33.Filter_APkUExWKTIiNJbZIcf8Uew<float> __p_DcfTaJYXy5FL6eWvdem4Qs, n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<int> __p_LsGSigw0PVVM0T35oaZzgO, n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_UQOerRAkmh3OHUjhll3ckm, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_QuUj5N5Nlm3Mw3S9NClxmG, n33.Filter_APkUExWKTIiNJbZIcf8Uew<float> __p_A0MNNAUYuFVNyR9vTGNSiB, n33.Filter_APkUExWKTIiNJbZIcf8Uew<n6.Vector2> __p_TEbOE3hfcbRNYbrCMYW3Of, n33.Filter_APkUExWKTIiNJbZIcf8Uew<float> __p_DfifmDyccYrLgrP64KFTpP, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_PsaAfzXD84KO93iaIihy7y, n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H __p_KVV2iJErwuVPVmTmLUPGTE, n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_JnkgbH4fHoTQYTAn2zhIC3)
        {
            n26.OrbitCameraControls_FBxS20I0dg6Nl63P2ejQR3 that_0 = this;
            if (this.__GetContext__().IsImmutable)
    ...
    [n1.ElementAttribute(TracingId = 65793U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "AUeBaqjRxtyMQXqPbXlu4W", Name = "SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W")]
    [n2.SerializableAttribute]
    public class SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W CreateDefault()
        {
            var instance = new SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W Join(n26.CameraControls_R Camera_Controls_In, n7.IMouse Mouse_Device_In, n7.IKeyboard Keyboard_Device_In, [n4.SerializedDefaultValueAttribute("True", false)] bool Enabled_In, out n26.CameraControls_R Camera_Controls_Out)
        {
            ...
            n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W that_81 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            n1.NodeContext Node_Context_0 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "ASXJHLEPWRkMgPkSUS4grL", 71387U);
            var Output_1 = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.Create(Node_Context: Node_Context_0);
            n1.NodeContext Node_Context_2 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "O1gE9Sji7qTLrgAHqYDZOQ", 71430U);
            var Output_3 = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.Create(Node_Context: Node_Context_2);
            n1.NodeContext Node_Context_4 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "JW3BvWmk3n0P1I8Wnc75sY", 71468U);
            var Output_5 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_4);
            n1.NodeContext Node_Context_6 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "LxX3YZTgoQ6NU3iiHBG1jC", 71484U);
            var Output_7 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_6);
            n1.NodeContext Node_Context_8 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "FeA0D0YTPs4L9Q7PF6Y0mB", 71510U);
            var Output_9 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_8);
            n1.NodeContext Node_Context_10 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Cabk3E3DIGZMNQFZ39qrUA", 71526U);
            var Output_11 = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.Create(Node_Context: Node_Context_10);
            n1.NodeContext Node_Context_12 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "SUKyGjU8gVuLGxFjQbnqd7", 71578U);
            var Output_13 = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2>.Create<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>(Node_Context: Node_Context_12);
            n1.NodeContext Node_Context_14 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "MQbkHGkQUqQOQFME8ECTXr", 71592U);
            n24.IClock Clock_15 = n23._Operations_.CreateDefault();
            var Output_16 = n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H.Create(Node_Context: Node_Context_14, Clock_In: Clock_15);
            n1.NodeContext Node_Context_17 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "Aioj0yNEt4YNNL8NIh1yMC", 71736U);
            var Output_18 = n16.TogEdge_GJoUlOOEtqiM4g67HVecyr.Create(Node_Context: Node_Context_17);
            n1.NodeContext Node_Context_19 = Node_Context.CreateSubContext("USVpn2wMsrSLK5oj1XAsi5", "DHzRhFZ6C7YOjiwk9pqpnZ", 72491U);
            var Output_20 = n16.FlipFlop_CJjTkCTbntqL2s5d9CL0vC.Create(Node_Context: Node_Context_19);
            n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W that_21 = this;
        ...
        public n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W __CreateDefault__()
        {
            n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W that_0 = this;
            this.__slot_U6FKNhjT9nuQKPvhnBxV9v = 0F;
            this.__p_ASXJHLEPWRkMgPkSUS4grL = n20.MouseState_BNOhaxXysw1MZBzyJMI18t.CreateDefault();
            this.__p_SUKyGjU8gVuLGxFjQbnqd7 = n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2>.CreateDefault<n12.__AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5>();
            this.__p_O1gE9Sji7qTLrgAHqYDZOQ = n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ.CreateDefault();
            this.__p_FeA0D0YTPs4L9Q7PF6Y0mB = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            this.__p_LxX3YZTgoQ6NU3iiHBG1jC = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            this.__p_Cabk3E3DIGZMNQFZ39qrUA = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
            this.__p_JW3BvWmk3n0P1I8Wnc75sY = n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv.CreateDefault();
        ...
        [n1.ElementAttribute(TracingId = 71332U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "FmKMu7TH567QTYRBFUEtRT", Name = "__slot_FmKMu7TH567QTYRBFUEtRT")]
        public static string __slot_FmKMu7TH567QTYRBFUEtRT = "R";
        [n1.ElementAttribute(TracingId = 71340U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "H5AozzvWbNSPyJRnGZaInv", Name = "__slot_H5AozzvWbNSPyJRnGZaInv")]
        public static string __slot_H5AozzvWbNSPyJRnGZaInv = "Z";
        [n1.ElementAttribute(TracingId = 71348U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "T7jqm3OjsmAPwREcoMH9Gh", Name = "__slot_T7jqm3OjsmAPwREcoMH9Gh")]
        public static string __slot_T7jqm3OjsmAPwREcoMH9Gh = "O";
        [n1.ElementAttribute(TracingId = 71353U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "RTzx2ElnplUPWNiDyP0CMU", Name = "__slot_RTzx2ElnplUPWNiDyP0CMU")]
        public static string __slot_RTzx2ElnplUPWNiDyP0CMU = "P";
        [n1.ElementAttribute(TracingId = 71358U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Uo6alaXXQutNMobmQV8DoX", Name = "__slot_Uo6alaXXQutNMobmQV8DoX")]
        public static float __slot_Uo6alaXXQutNMobmQV8DoX = 0.5F;
        [n1.ElementAttribute(TracingId = 71366U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "H5DBl3pAsqDPBDdGS63JdA", Name = "__slot_H5DBl3pAsqDPBDdGS63JdA")]
        public static float __slot_H5DBl3pAsqDPBDdGS63JdA = 1F;
        [n1.ElementAttribute(TracingId = 71371U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KAjrwoFFM7nQbJntaOJ0x9", Name = "__slot_KAjrwoFFM7nQbJntaOJ0x9")]
        public static float __slot_KAjrwoFFM7nQbJntaOJ0x9 = 5F;
        [n1.ElementAttribute(TracingId = 72676U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "EAORjq9eEqsQcsSUBsjerc", Name = "__slot_EAORjq9eEqsQcsSUBsjerc")]
        public static float __slot_EAORjq9eEqsQcsSUBsjerc = 0.25F;
        [n1.ElementAttribute(TracingId = 72685U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "VVAXyGMXjeyLxT90LKyX0W", Name = "__slot_VVAXyGMXjeyLxT90LKyX0W")]
        public static float __slot_VVAXyGMXjeyLxT90LKyX0W = 0.01F;
        [n1.ElementAttribute(TracingId = 72689U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "U6FKNhjT9nuQKPvhnBxV9v", Name = "__slot_U6FKNhjT9nuQKPvhnBxV9v")]
        public float __slot_U6FKNhjT9nuQKPvhnBxV9v;
        [n1.ElementAttribute(TracingId = 72691U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "CoiyDgGcnJ7PV3MCn2hXvx", Name = "__slot_CoiyDgGcnJ7PV3MCn2hXvx")]
        public static float __slot_CoiyDgGcnJ7PV3MCn2hXvx = 1F;
        [n1.ElementAttribute(TracingId = 72701U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "GoVN7pE5txhMxsrVzvGlcl", Name = "__slot_GoVN7pE5txhMxsrVzvGlcl")]
        public static string __slot_GoVN7pE5txhMxsrVzvGlcl = "SPEEDS";
        [n1.ElementAttribute(TracingId = 71387U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "ASXJHLEPWRkMgPkSUS4grL", Name = "MouseState", IsManaged = true, IsAutoGenerated = true)]
        public n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_ASXJHLEPWRkMgPkSUS4grL;
        [n1.ElementAttribute(TracingId = 71578U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "SUKyGjU8gVuLGxFjQbnqd7", Name = "FrameDifference", IsManaged = true, IsAutoGenerated = true)]
        public n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2> __p_SUKyGjU8gVuLGxFjQbnqd7;
        [n1.ElementAttribute(TracingId = 71430U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "O1gE9Sji7qTLrgAHqYDZOQ", Name = "KeyboardState", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_O1gE9Sji7qTLrgAHqYDZOQ;
        [n1.ElementAttribute(TracingId = 71510U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "FeA0D0YTPs4L9Q7PF6Y0mB", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_FeA0D0YTPs4L9Q7PF6Y0mB;
        [n1.ElementAttribute(TracingId = 71484U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "LxX3YZTgoQ6NU3iiHBG1jC", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_LxX3YZTgoQ6NU3iiHBG1jC;
        [n1.ElementAttribute(TracingId = 71526U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Cabk3E3DIGZMNQFZ39qrUA", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_Cabk3E3DIGZMNQFZ39qrUA;
        [n1.ElementAttribute(TracingId = 71468U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "JW3BvWmk3n0P1I8Wnc75sY", Name = "KeyMatch", IsManaged = true, IsAutoGenerated = true)]
        public n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_JW3BvWmk3n0P1I8Wnc75sY;
        [n1.ElementAttribute(TracingId = 71592U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "MQbkHGkQUqQOQFME8ECTXr", Name = "TimerFlop", IsManaged = true, IsAutoGenerated = true)]
        public n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H __p_MQbkHGkQUqQOQFME8ECTXr;
        [n1.ElementAttribute(TracingId = 71736U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "Aioj0yNEt4YNNL8NIh1yMC", Name = "TogEdge", IsManaged = true, IsAutoGenerated = true)]
        public n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_Aioj0yNEt4YNNL8NIh1yMC;
        [n1.ElementAttribute(TracingId = 72491U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "DHzRhFZ6C7YOjiwk9pqpnZ", Name = "FlipFlop", IsManaged = true, IsAutoGenerated = true)]
        ...
        internal SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W __WITH__(float __slot_U6FKNhjT9nuQKPvhnBxV9v, n20.MouseState_BNOhaxXysw1MZBzyJMI18t __p_ASXJHLEPWRkMgPkSUS4grL, n22.FrameDifference_UGiMzXJ8Pe3NmV2nXH2LpH<n6.Vector2> __p_SUKyGjU8gVuLGxFjQbnqd7, n21.KeyboardState_FWRYiZyypwZPvLPUVDhSgJ __p_O1gE9Sji7qTLrgAHqYDZOQ, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_FeA0D0YTPs4L9Q7PF6Y0mB, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_LxX3YZTgoQ6NU3iiHBG1jC, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_Cabk3E3DIGZMNQFZ39qrUA, n21.KeyMatch_Pj2Pg6KELmnQZbr7B4gLzv __p_JW3BvWmk3n0P1I8Wnc75sY, n16.TimerFlop_FdX7N0Rk7AuQXGSKZzxW0H __p_MQbkHGkQUqQOQFME8ECTXr, n16.TogEdge_GJoUlOOEtqiM4g67HVecyr __p_Aioj0yNEt4YNNL8NIh1yMC, n16.FlipFlop_CJjTkCTbntqL2s5d9CL0vC __p_DHzRhFZ6C7YOjiwk9pqpnZ)
        {
            n26.SoftimageCameraControls_AUeBaqjRxtyMQXqPbXlu4W that_0 = this;
            if (this.__GetContext__().IsImmutable)
...
{
    [n1.ElementAttribute(TracingId = 72885U, DocumentId = "USVpn2wMsrSLK5oj1XAsi5", PersistentId = "KufR6HoJJ0tMFJWFmyb2N5", Name = "VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5")]
    [n2.SerializableAttribute]
    public class VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5 : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n31.VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5 Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n31.VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5 CreateDefault()
        {
            var instance = new VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n31.VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5 Update()
        {
            return this;
        }

        public n31.VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5 __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            return this;
        }

        public n31.VL_CamerasApplication_KufR6HoJJ0tMFJWFmyb2N5 __CreateDefault__()
        {
            return this;
        }
...
{
    public struct __AdaptiveImplementations__USVpn2wMsrSLK5oj1XAsi5 : n37.IAdaptiveOperatorGreater<float>, n37.IAdaptiveOperatorLess<float>, n38.IAdaptiveCreateDefault<n6.Vector2>, n37.IAdaptiveOperatorMinus<n6.Vector2>, n38.IAdaptiveCreateDefault<int>, n37.IAdaptiveOperatorMinus<int>, n37.IAdaptiveMin<float>, n37.IAdaptiveMax<float>, n38.IAdaptiveCreateDefault<float>, n37.IAdaptiveAvoidNaN<float>, n37.IAdaptiveIsNaN<float>, n37.IAdaptiveNE<float>, n37.IAdaptiveLerp<float>, n37.IAdaptiveAvoidNaN<n6.Vector2>, n37.IAdaptiveNE<n6.Vector2>, n37.IAdaptiveLerp<n6.Vector2>
    {
