...
internal sealed class Program
{
    ...
    {
        using (var appHost = new n9.WindowsFormsAppHost<n3.SolarSystemApplication_EnZiuY2Vb0QLrZO1M4x3Xe>(c => n3.SolarSystemApplication_EnZiuY2Vb0QLrZO1M4x3Xe.Create(c), s => ((n3.SolarSystemApplication_EnZiuY2Vb0QLrZO1M4x3Xe)s).Update()))
            appHost.Run();
    }
}