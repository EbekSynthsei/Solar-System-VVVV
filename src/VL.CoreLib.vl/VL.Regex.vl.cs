...
using n9 = e2::VL.Lib.Primitive;
using n11 = e2::VL.Lib.Primitive.Object;
using n4 = e5::VL.Core.CompilerServices;
using n10 = global::System.Collections.Generic;
using n7 = _VL_Regex_.Text.RegularExpressions.Patched.SpecialCharacters.Experimental;
using n6 = e2::VL.Lib.Primitive.CacheRegion;
using n12 = global::System.Text;
using n5 = global::System.Text.RegularExpressions;
using n1 = e5::VL.Core;
using n15 = e5::VL.Lib.Runtime;
using n2 = global::System;
using n17 = _VL_Regex_.Text.RegularExpressions.Patched.Alternation.Experimental;
using n16 = _VL_Regex_.Text.RegularExpressions.Patched.CharacterClasses.Experimental;
using n19 = _VL_Regex_.Text.RegularExpressions.Patched.Quantifiers.Experimental;
using n8 = global::System.Runtime.CompilerServices;
using n14 = e5::VL.Lib.Collections;
using n18 = _VL_Regex_.Text.RegularExpressions.Patched.Anchors.Experimental;
...
{
    [n1.ElementAttribute(TracingId = 266524U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "No3CCkpgB8zO94DQbGm6O4", Name = "IsMatch_No3CCkpgB8zO94DQbGm6O4")]
    ...
    public class IsMatch_No3CCkpgB8zO94DQbGm6O4 : n1.VLObject, n2.IDisposable
    {
        ...
        public n3.IsMatch_No3CCkpgB8zO94DQbGm6O4 Update(string Input_In, string Pattern_In, [n4.SerializedDefaultValueAttribute("Compiled", false)] n5.RegexOptions Options_In, out bool Result_Out)
        {
            ...
            if (Has_Changed_14)
            {
                ...
                n11.ObjectHelpers.IsAssigned(x: __auto_8, result: out bool Result_16, notAssigned: out bool Not_Assigned_17);
                bool __auto_18;
                if (Result_16)
                {
        ...
        [n1.ElementAttribute(TracingId = 266528U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "O1rkEy1RHn3NlMpcwCbBTq", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n6.Manager<n2.ValueTuple<string, n5.RegexOptions>, n2.ValueTuple<n5.Regex>> __cache_O1rkEy1RHn3NlMpcwCbBTq = null;
        [n1.ElementAttribute(TracingId = 266559U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "TzW1uqoYLntN6leNn86oW7", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 266654U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "F5NEdQWxM1sMWC1M7hYyBj", Name = "Replace_F5NEdQWxM1sMWC1M7hYyBj")]
    [n2.SerializableAttribute]
    public class Replace_F5NEdQWxM1sMWC1M7hYyBj : n1.VLObject, n2.IDisposable
    {
        ...
        [n1.ElementAttribute(TracingId = 266657U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "U14jUiVqjzoLhR3Cnu355R", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n6.Manager<n2.ValueTuple<string, n5.RegexOptions>, n2.ValueTuple<n5.Regex>> __cache_U14jUiVqjzoLhR3Cnu355R = null;
        [n1.ElementAttribute(TracingId = 266689U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "RsRnu9h2g59LEH3VgogPcX", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 266824U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "NkW4XSRiiqZLVwUsqFQNTW", Name = "Split_NkW4XSRiiqZLVwUsqFQNTW")]
    [n2.SerializableAttribute]
    public class Split_NkW4XSRiiqZLVwUsqFQNTW : n1.VLObject, n2.IDisposable
    {
        ...
        public n3.Split_NkW4XSRiiqZLVwUsqFQNTW Update(string Input_In, string Pattern_In, [n4.SerializedDefaultValueAttribute("Compiled", false)] n5.RegexOptions Options_In, out n14.Spread<string> Result_Out)
        {
            bool Force_0 = false;
            bool Dispose_Cached_Outputs_1 = false;
            ...
            if (manager_11 is null)
            {
                manager_11 = new n6.Manager<n2.ValueTuple<n5.Regex, string>, n2.ValueTuple<n14.Spread<string>>>(n2.ValueTuple.Create(n13._Operations_.CreateDefault<string>()));
            }
            ...
            if (Has_Changed_14)
            {
                if (Dispose_Cached_Outputs_10)
                    manager_11.DisposeOutputs();
                n11.ObjectHelpers.IsAssigned(x: __auto_8, result: out bool Result_16, notAssigned: out bool Not_Assigned_17);
                n14.Spread<string> __auto_18;
                if (Result_16)
                {
                    var Result_20 = __auto_8.Split(input: Input_In);
                    n10.IEnumerable<string> Input_21 = (n10.IEnumerable<string>)Result_20;
                    n13._Operations_.FromSequence<string>(Input_In: Input_21, Result_Out: out n14.Spread<string> Result_22);
                    __auto_18 = Result_22;
                }
                else
                {
        ...
        [n1.ElementAttribute(TracingId = 266827U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "CDO64VnHXeQNEHe9KCRHOr", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n6.Manager<n2.ValueTuple<string, n5.RegexOptions>, n2.ValueTuple<n5.Regex>> __cache_CDO64VnHXeQNEHe9KCRHOr = null;
        [n1.ElementAttribute(TracingId = 269288U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "SOaqhdLR9GbOVzqLSXGLba", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n6.Manager<n2.ValueTuple<n5.Regex, string>, n2.ValueTuple<n14.Spread<string>>> __cache_SOaqhdLR9GbOVzqLSXGLba = null;
        ...
        internal Split_NkW4XSRiiqZLVwUsqFQNTW __WITH__(n6.Manager<n2.ValueTuple<string, n5.RegexOptions>, n2.ValueTuple<n5.Regex>> __cache_CDO64VnHXeQNEHe9KCRHOr, n6.Manager<n2.ValueTuple<n5.Regex, string>, n2.ValueTuple<n14.Spread<string>>> __cache_SOaqhdLR9GbOVzqLSXGLba)
        {
            n3.Split_NkW4XSRiiqZLVwUsqFQNTW that_0 = this;
            if (this.__GetContext__().IsImmutable)
    ...
    [n1.ElementAttribute(TracingId = 272296U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "EWOwsOz68C1Mwnt5excx6S", Name = "Matches_EWOwsOz68C1Mwnt5excx6S")]
    [n2.SerializableAttribute]
    public class Matches_EWOwsOz68C1Mwnt5excx6S : n1.VLObject, n2.IDisposable
    {
        ...
        public n3.Matches_EWOwsOz68C1Mwnt5excx6S Update(string Input_In, string Pattern_In, [n4.SerializedDefaultValueAttribute("Compiled", false)] n5.RegexOptions Options_In, out n14.Spread<string> Result_Out, out n14.Spread<n14.Spread<string>> Result_Groups_Out)
        {
            bool Force_0 = false;
            bool Dispose_Cached_Outputs_1 = false;
            ...
            if (manager_11 is null)
            {
                manager_11 = new n6.Manager<n2.ValueTuple<n5.Regex, string>, n2.ValueTuple<n14.Spread<string>, n14.Spread<n14.Spread<string>>>>((n13._Operations_.CreateDefault<string>(), n13._Operations_.CreateDefault<n14.Spread<string>>()));
            }
            ...
            if (Has_Changed_14)
            {
                ...
                n11.ObjectHelpers.IsAssigned(x: __auto_8, result: out bool Result_16, notAssigned: out bool Not_Assigned_17);
                n14.Spread<string> __auto_18;
                n14.Spread<n14.Spread<string>> __auto_19;
                ...
                if (Result_16)
                {
                    if (state_20 == null)
                    {
                        ...
                        {__cp_NVlcT2aTwjHLL2BeZUn57J = n13._Operations_.CreateDefault<string>(), __cp_Glqv2NgNEiCO49CfQPsRIu = n13._Operations_.CreateDefault<n14.Spread<string>>()};
                    }

                    var Result_21 = __auto_8.Matches(input: Input_In);
                    var Count_22 = Result_21.Count;
                    var manager_42 = state_20.__loop_J6mVhFbgvTmPIBS0sMaEGG ?? new n15.ImmutableLifetimeManager();
                    ...
                    try
                    {
                        for (var i_23 = 0; i_23 < Count_22; i_23++)
                        {
                            ...
                            if (!iterator_43.MoveNext(out state_25))
                            {
                                ...
                                {__cp_FGgl7UtNMg0NGIeMLEqel1 = n13._Operations_.CreateDefault<string>()});
                            }
                ...
                {
                    __auto_18 = n13._Operations_.CreateDefault<string>();
                    __auto_19 = n13._Operations_.CreateDefault<n14.Spread<string>>();
                }
        ...
        [n1.ElementAttribute(TracingId = 272300U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "J0nHhTg5jp5QF5rCpKFEam", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n6.Manager<n2.ValueTuple<string, n5.RegexOptions>, n2.ValueTuple<n5.Regex>> __cache_J0nHhTg5jp5QF5rCpKFEam = null;
        [n1.ElementAttribute(TracingId = 272332U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "VqmFbQvaXnhNDNRzDfxFgH", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        public n6.Manager<n2.ValueTuple<n5.Regex, string>, n2.ValueTuple<n14.Spread<string>, n14.Spread<n14.Spread<string>>>> __cache_VqmFbQvaXnhNDNRzDfxFgH = null;
        [n1.ElementAttribute(TracingId = 272419U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "DufkOIz5zO2NvNTL01sCE3", Name = "__slot_DufkOIz5zO2NvNTL01sCE3")]
        ...
        internal Matches_EWOwsOz68C1Mwnt5excx6S __WITH__(n6.Manager<n2.ValueTuple<string, n5.RegexOptions>, n2.ValueTuple<n5.Regex>> __cache_J0nHhTg5jp5QF5rCpKFEam, n6.Manager<n2.ValueTuple<n5.Regex, string>, n2.ValueTuple<n14.Spread<string>, n14.Spread<n14.Spread<string>>>> __cache_VqmFbQvaXnhNDNRzDfxFgH)
        {
            n3.Matches_EWOwsOz68C1Mwnt5excx6S that_0 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public class __HKxq5O2oO7jQMMbq2ozF0b : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(IsManaged = true, IsAutoGenerated = true)]
            public n15.ImmutableLifetimeManager __loop_J6mVhFbgvTmPIBS0sMaEGG;
            [n1.ElementAttribute(IsAutoGenerated = true)]
            public n14.Spread<string> __cp_NVlcT2aTwjHLL2BeZUn57J;
            [n1.ElementAttribute(IsAutoGenerated = true)]
            public n14.Spread<n14.Spread<string>> __cp_Glqv2NgNEiCO49CfQPsRIu;
            ...
            internal __HKxq5O2oO7jQMMbq2ozF0b __WITH__(n15.ImmutableLifetimeManager __loop_J6mVhFbgvTmPIBS0sMaEGG, n14.Spread<string> __cp_NVlcT2aTwjHLL2BeZUn57J, n14.Spread<n14.Spread<string>> __cp_Glqv2NgNEiCO49CfQPsRIu)
            {
        ...
        public class __NfTOSoOp5y1MWzqYObVhaU : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(IsAutoGenerated = true)]
            public n14.Spread<string> __cp_FGgl7UtNMg0NGIeMLEqel1;
            ...
            internal __NfTOSoOp5y1MWzqYObVhaU __WITH__(n14.Spread<string> __cp_FGgl7UtNMg0NGIeMLEqel1)
            {
    ...
    [n1.ElementAttribute(TracingId = 273940U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "VLBfcL2fMjXLFtW0rDJYRo", Name = "IsEmail_VLBfcL2fMjXLFtW0rDJYRo")]
    [n2.SerializableAttribute]
    public class IsEmail_VLBfcL2fMjXLFtW0rDJYRo : n1.VLObject, n2.IDisposable
    {
        ...
        public n3.IsEmail_VLBfcL2fMjXLFtW0rDJYRo __Create__(n1.NodeContext Node_Context)
        {
            ...
            string Input_10 = "(?!";
            string Input_3_11 = ")";
            var Output_12 = n9.StringExtensions.Plus(input: Input_10, input2: Output_9);
            var Output_13 = n9.StringExtensions.Plus(input: Output_12, input2: Input_3_11);
            var Output_14 = n9.StringExtensions.Plus(input: Output_9, input2: Output_13);
            string Input_15 = "(";
            string Input_3_16 = ")";
            var Output_17 = n9.StringExtensions.Plus(input: Input_15, input2: Output_14);
            var Output_18 = n9.StringExtensions.Plus(input: Output_17, input2: Input_3_16);
            var Output_19 = n5.Regex.Escape(str: __pad_FX1pWN95O0VP9lgIkiQAUe_1);
            n16._Operations_.AnyWordChar(Output_Out: out string Output_20);
            var Output_21 = n9.StringExtensions.Plus(input: Output_19, input2: Output_20);
            string Input_22 = "[";
            string Input_3_23 = "]";
            var Output_24 = n9.StringExtensions.Plus(input: Input_22, input2: Output_21);
            var Output_25 = n9.StringExtensions.Plus(input: Output_24, input2: Input_3_23);
            var builder_26 = n4.CollectionBuilders.GetBuilder(n13._Operations_.CreateDefault<string>(), 2);
            builder_26.Add(Output_18);
            builder_26.Add(Output_25);
            var __pin_group_Input_In_MfDmnNKJytlLx83UoneR7H_27 = builder_26.Commit();
            n17._Operations_.OR_RegExpr(Input_In: __pin_group_Input_In_MfDmnNKJytlLx83UoneR7H_27, Output_Out: out string Output_28);
            string Input_2_29 = "*";
            var Output_30 = n9.StringExtensions.Plus(input: Output_28, input2: Input_2_29);
            string Input_31 = "0";
            string Input_2_32 = "9";
            string Input_33 = "";
            string Input_3_34 = "-";
            string Input_5_35 = "";
            var Output_36 = n9.StringExtensions.Plus(input: Input_33, input2: Input_31);
            var Output_37 = n9.StringExtensions.Plus(input: Output_36, input2: Input_3_34);
            var Output_38 = n9.StringExtensions.Plus(input: Output_37, input2: Input_2_32);
            var Output_39 = n9.StringExtensions.Plus(input: Output_38, input2: Input_5_35);
            string Input_40 = "a";
            string Input_2_41 = "z";
            string Input_42 = "";
            string Input_3_43 = "-";
            string Input_5_44 = "";
            var Output_45 = n9.StringExtensions.Plus(input: Input_42, input2: Input_40);
            var Output_46 = n9.StringExtensions.Plus(input: Output_45, input2: Input_3_43);
            var Output_47 = n9.StringExtensions.Plus(input: Output_46, input2: Input_2_41);
            var Output_48 = n9.StringExtensions.Plus(input: Output_47, input2: Input_5_44);
            var Output_49 = n9.StringExtensions.Plus(input: Output_39, input2: Output_48);
            string Input_50 = "[";
            string Input_3_51 = "]";
            var Output_52 = n9.StringExtensions.Plus(input: Input_50, input2: Output_49);
            var Output_53 = n9.StringExtensions.Plus(input: Output_52, input2: Input_3_51);
            var Output_54 = n9.StringExtensions.Plus(input: Output_53, input2: Output_30);
            string Input_55 = "(?<=";
            string Input_3_56 = ")";
            var Output_57 = n9.StringExtensions.Plus(input: Input_55, input2: Output_53);
            var Output_58 = n9.StringExtensions.Plus(input: Output_57, input2: Input_3_56);
            var Output_59 = n9.StringExtensions.Plus(input: Output_58, input2: __pad_Piv6KFNfHSaPnJB9f0eHpk_2);
            string Input_60 = "(";
            string Input_3_61 = ")";
            var Output_62 = n9.StringExtensions.Plus(input: Input_60, input2: Output_54);
            var Output_63 = n9.StringExtensions.Plus(input: Output_62, input2: Input_3_61);
            var Output_64 = n9.StringExtensions.Plus(input: Output_63, input2: Output_59);
            string Input_65 = "(";
            string Input_3_66 = ")";
            var Output_67 = n9.StringExtensions.Plus(input: Input_65, input2: Output_64);
            var Output_68 = n9.StringExtensions.Plus(input: Output_67, input2: Input_3_66);
            n16._Operations_.AnyChar(Output_Out: out string Output_69);
            string Input_2_70 = "+?";
            var Output_71 = n9.StringExtensions.Plus(input: Output_69, input2: Input_2_70);
            n7._Operations_.BackSlash(Output_Out: out string Output_72);
            string Input_73 = "(?<!";
            string Input_3_74 = ")";
            var Output_75 = n9.StringExtensions.Plus(input: Input_73, input2: Output_72);
            var Output_76 = n9.StringExtensions.Plus(input: Output_75, input2: Input_3_74);
            var Output_77 = n9.StringExtensions.Plus(input: Output_76, input2: __pad_PqKhdwNrKHvPCR32SV2SnV_4);
            var Output_78 = n9.StringExtensions.Plus(input: __pad_RsoOT7nQd3sPS0erPxsuCY_3, input2: Output_71);
            var Output_79 = n9.StringExtensions.Plus(input: Output_78, input2: Output_77);
            string Input_80 = "(";
            string Input_3_81 = ")";
            var Output_82 = n9.StringExtensions.Plus(input: Input_80, input2: Output_79);
            var Output_83 = n9.StringExtensions.Plus(input: Output_82, input2: Input_3_81);
            string Input_84 = "(?(";
            string Input_3_85 = ")";
            string Input_5_86 = "|";
            string Input_7_87 = ")";
            var Output_88 = n9.StringExtensions.Plus(input: Input_84, input2: __pad_RsoOT7nQd3sPS0erPxsuCY_3);
            var Output_89 = n9.StringExtensions.Plus(input: Output_88, input2: Input_3_85);
            var Output_90 = n9.StringExtensions.Plus(input: Output_89, input2: Output_83);
            var Output_91 = n9.StringExtensions.Plus(input: Output_90, input2: Input_5_86);
            var Output_92 = n9.StringExtensions.Plus(input: Output_91, input2: Output_68);
            var Output_93 = n9.StringExtensions.Plus(input: Output_92, input2: Input_7_87);
            n18._Operations_.StringStarts(Output_Out: out string Output_94);
            var Output_95 = n5.Regex.Escape(str: __pad_CkC403OQ4H7PjCmSUPg5sK_5);
            n16._Operations_.AnyDigit(Output_Out: out string Output_96);
            int N_97 = 1;
            int M_98 = 3;
            n19._Operations_.NToMTimes(Input_In: Output_96, N_In: N_97, M_In: M_98, Output_Out: out string Output_99);
            var Output_100 = n5.Regex.Escape(str: __pad_LxZmlESAQNBNZhSoWRN1AO_6);
            var Output_101 = n9.StringExtensions.Plus(input: Output_99, input2: Output_100);
            string Input_102 = "(";
            string Input_3_103 = ")";
            var Output_104 = n9.StringExtensions.Plus(input: Input_102, input2: Output_101);
            var Output_105 = n9.StringExtensions.Plus(input: Output_104, input2: Input_3_103);
            int N_106 = 3;
            n19._Operations_.ExactlyNTimes(Input_In: Output_105, N_In: N_106, Output_Out: out string Output_107);
            var Output_108 = n5.Regex.Escape(str: __pad_SSYbewlKII3QAMr0BRxHTP_7);
            var Output_109 = n9.StringExtensions.Plus(input: Output_95, input2: Output_107);
            var Output_110 = n9.StringExtensions.Plus(input: Output_109, input2: Output_99);
            var Output_111 = n9.StringExtensions.Plus(input: Output_110, input2: Output_108);
            string Input_112 = "(";
            string Input_3_113 = ")";
            var Output_114 = n9.StringExtensions.Plus(input: Input_112, input2: Output_111);
            var Output_115 = n9.StringExtensions.Plus(input: Output_114, input2: Input_3_113);
            string Input_116 = "0";
            string Input_2_117 = "9";
            string Input_118 = "";
            string Input_3_119 = "-";
            string Input_5_120 = "";
            var Output_121 = n9.StringExtensions.Plus(input: Input_118, input2: Input_116);
            var Output_122 = n9.StringExtensions.Plus(input: Output_121, input2: Input_3_119);
            var Output_123 = n9.StringExtensions.Plus(input: Output_122, input2: Input_2_117);
            var Output_124 = n9.StringExtensions.Plus(input: Output_123, input2: Input_5_120);
            string Input_125 = "a";
            string Input_2_126 = "z";
            string Input_127 = "";
            string Input_3_128 = "-";
            string Input_5_129 = "";
            var Output_130 = n9.StringExtensions.Plus(input: Input_127, input2: Input_125);
            var Output_131 = n9.StringExtensions.Plus(input: Output_130, input2: Input_3_128);
            var Output_132 = n9.StringExtensions.Plus(input: Output_131, input2: Input_2_126);
            var Output_133 = n9.StringExtensions.Plus(input: Output_132, input2: Input_5_129);
            var Output_134 = n9.StringExtensions.Plus(input: Output_124, input2: Output_133);
            string Input_135 = "[";
            string Input_3_136 = "]";
            var Output_137 = n9.StringExtensions.Plus(input: Input_135, input2: Output_134);
            var Output_138 = n9.StringExtensions.Plus(input: Output_137, input2: Input_3_136);
            string Input_139 = "-";
            var Output_140 = n9.StringExtensions.Plus(input: Input_139, input2: Output_134);
            string Input_141 = "[";
            string Input_3_142 = "]";
            var Output_143 = n9.StringExtensions.Plus(input: Input_141, input2: Output_140);
            var Output_144 = n9.StringExtensions.Plus(input: Output_143, input2: Input_3_142);
            string Input_2_145 = "*";
            var Output_146 = n9.StringExtensions.Plus(input: Output_144, input2: Input_2_145);
            var Output_147 = n5.Regex.Escape(str: __pad_CjCnSglfsh7PEs5q6Vylee_8);
            var Output_148 = n9.StringExtensions.Plus(input: Output_138, input2: Output_146);
            var Output_149 = n9.StringExtensions.Plus(input: Output_148, input2: Output_138);
            var Output_150 = n9.StringExtensions.Plus(input: Output_149, input2: Output_147);
            string Input_151 = "(";
            string Input_3_152 = ")";
            var Output_153 = n9.StringExtensions.Plus(input: Input_151, input2: Output_150);
            var Output_154 = n9.StringExtensions.Plus(input: Output_153, input2: Input_3_152);
            string Input_2_155 = "+";
            var Output_156 = n9.StringExtensions.Plus(input: Output_154, input2: Input_2_155);
            int N_157 = 0;
            int M_158 = 22;
            n19._Operations_.NToMTimes(Input_In: Output_144, N_In: N_157, M_In: M_158, Output_Out: out string Output_159);
            var Output_160 = n9.StringExtensions.Plus(input: Output_138, input2: Output_159);
            var Output_161 = n9.StringExtensions.Plus(input: Output_160, input2: Output_138);
            var Output_162 = n9.StringExtensions.Plus(input: Output_156, input2: Output_161);
            string Input_163 = "(";
            string Input_3_164 = ")";
            var Output_165 = n9.StringExtensions.Plus(input: Input_163, input2: Output_162);
            var Output_166 = n9.StringExtensions.Plus(input: Output_165, input2: Input_3_164);
            string Input_167 = "(?(";
            string Input_3_168 = ")";
            string Input_5_169 = "|";
            string Input_7_170 = ")";
            var Output_171 = n9.StringExtensions.Plus(input: Input_167, input2: Output_95);
            var Output_172 = n9.StringExtensions.Plus(input: Output_171, input2: Input_3_168);
            var Output_173 = n9.StringExtensions.Plus(input: Output_172, input2: Output_115);
            var Output_174 = n9.StringExtensions.Plus(input: Output_173, input2: Input_5_169);
            var Output_175 = n9.StringExtensions.Plus(input: Output_174, input2: Output_166);
            var Output_176 = n9.StringExtensions.Plus(input: Output_175, input2: Input_7_170);
            n18._Operations_.StringEnds(Output_Out: out string Output_177);
            var Output_178 = n9.StringExtensions.Plus(input: Output_94, input2: Output_93);
            var Output_179 = n9.StringExtensions.Plus(input: Output_178, input2: Output_176);
            var Output_180 = n9.StringExtensions.Plus(input: Output_179, input2: Output_177);
            string __pad_VmTcE6UsOrNOAhsPLKceUa_181 = Output_115;
            string __auto_182 = Output_180;
            n1.NodeContext Node_Context_183 = Node_Context.CreateSubContext("BrdqoPCUQm5MjX4cJz5Rvf", "RGmqrzS6x07NtKxVZSO29K", 273943U);
        ...
        public n3.IsEmail_VLBfcL2fMjXLFtW0rDJYRo __CreateDefault__()
        {
            ...
            this.Expression = "";
            this.__pin_group_Input_In_MfDmnNKJytlLx83UoneR7H = n13._Operations_.CreateDefault<string>();
        ...
        [n1.ElementAttribute(TracingId = 273948U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "TLKq7rxPQVBLVWwbDV89Vz", Name = "__slot_TLKq7rxPQVBLVWwbDV89Vz")]
        ...
        [n1.ElementAttribute(TracingId = 273954U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "QysWKyPSYeFN79qoGLwCzd", Name = "__slot_QysWKyPSYeFN79qoGLwCzd")]
        ...
        [n1.ElementAttribute(TracingId = 273955U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "BC31CkD1rnjNznDihPZIZD", Name = "__slot_BC31CkD1rnjNznDihPZIZD")]
        ...
        [n1.ElementAttribute(TracingId = 273965U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "TCIgAf0BTCiLtdgaqRzrok", Name = "__slot_TCIgAf0BTCiLtdgaqRzrok")]
        ...
        [n1.ElementAttribute(TracingId = 273974U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "RsoOT7nQd3sPS0erPxsuCY", Name = "__slot_RsoOT7nQd3sPS0erPxsuCY")]
        public static string __slot_RsoOT7nQd3sPS0erPxsuCY = "\"";
        [n1.ElementAttribute(TracingId = 273991U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "PqKhdwNrKHvPCR32SV2SnV", Name = "__slot_PqKhdwNrKHvPCR32SV2SnV")]
        public static string __slot_PqKhdwNrKHvPCR32SV2SnV = "\"@";
        [n1.ElementAttribute(TracingId = 273992U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "NXevPdoS11VNiybw5YJdXJ", Name = "__slot_NXevPdoS11VNiybw5YJdXJ")]
        public static string __slot_NXevPdoS11VNiybw5YJdXJ = "\"na me\"@";
        [n1.ElementAttribute(TracingId = 274029U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "FnjtC339tHzMv8YrOUTOX3", Name = "__slot_FnjtC339tHzMv8YrOUTOX3")]
        public static string __slot_FnjtC339tHzMv8YrOUTOX3 = ".";
        [n1.ElementAttribute(TracingId = 274030U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "FbLbrVb2xDiNGo7CihEOLt", Name = "__slot_FbLbrVb2xDiNGo7CihEOLt")]
        public static string __slot_FbLbrVb2xDiNGo7CihEOLt = "number or small letter";
        [n1.ElementAttribute(TracingId = 274048U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "Piv6KFNfHSaPnJB9f0eHpk", Name = "__slot_Piv6KFNfHSaPnJB9f0eHpk")]
        public static string __slot_Piv6KFNfHSaPnJB9f0eHpk = "@";
        [n1.ElementAttribute(TracingId = 274055U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "BDXKv4FyL4QPQbf90uMkPs", Name = "__slot_BDXKv4FyL4QPQbf90uMkPs")]
        public static string __slot_BDXKv4FyL4QPQbf90uMkPs = "\"my name\"@ \r\n  or \r\n2+2@";
        [n1.ElementAttribute(TracingId = 274067U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "CkC403OQ4H7PjCmSUPg5sK", Name = "__slot_CkC403OQ4H7PjCmSUPg5sK")]
        public static string __slot_CkC403OQ4H7PjCmSUPg5sK = "[";
        [n1.ElementAttribute(TracingId = 274076U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "SSYbewlKII3QAMr0BRxHTP", Name = "__slot_SSYbewlKII3QAMr0BRxHTP")]
        public static string __slot_SSYbewlKII3QAMr0BRxHTP = "]";
        [n1.ElementAttribute(TracingId = 274077U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "VmTcE6UsOrNOAhsPLKceUa", Name = "__slot_VmTcE6UsOrNOAhsPLKceUa")]
        public string __slot_VmTcE6UsOrNOAhsPLKceUa;
        [n1.ElementAttribute(TracingId = 274090U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "LxZmlESAQNBNZhSoWRN1AO", Name = "__slot_LxZmlESAQNBNZhSoWRN1AO")]
        public static string __slot_LxZmlESAQNBNZhSoWRN1AO = ".";
        [n1.ElementAttribute(TracingId = 274101U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "OBkVU9u5tbTMIouDsX9TFN", Name = "__slot_OBkVU9u5tbTMIouDsX9TFN")]
        public static string __slot_OBkVU9u5tbTMIouDsX9TFN = "IP: \r\n[3.222.31.1]";
        [n1.ElementAttribute(TracingId = 274102U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "ItZZKDukd3aPXTmpNwMNpS", Name = "__slot_ItZZKDukd3aPXTmpNwMNpS")]
        public static string __slot_ItZZKDukd3aPXTmpNwMNpS = "or";
        [n1.ElementAttribute(TracingId = 274106U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "FX1pWN95O0VP9lgIkiQAUe", Name = "__slot_FX1pWN95O0VP9lgIkiQAUe")]
        public static string __slot_FX1pWN95O0VP9lgIkiQAUe = "-!#$%'*+=?^`{}|~";
        [n1.ElementAttribute(TracingId = 274107U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "DY0WtoEcqlKQBLF5tiWoaN", Name = "__slot_DY0WtoEcqlKQBLF5tiWoaN")]
        ...
        [n1.ElementAttribute(TracingId = 274114U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "OKZZ55Vqmx1MDzVhv2MaXl", Name = "__slot_OKZZ55Vqmx1MDzVhv2MaXl")]
        public static string __slot_OKZZ55Vqmx1MDzVhv2MaXl = "[-!#$%&'*+/=?^`{}&#124;~\\w] is an alternative encoding";
        [n1.ElementAttribute(TracingId = 274134U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "NVNQEbk8lPZMIdu2qkEIlY", Name = "__slot_NVNQEbk8lPZMIdu2qkEIlY")]
        public static string __slot_NVNQEbk8lPZMIdu2qkEIlY = "number or small letter";
        [n1.ElementAttribute(TracingId = 274151U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "H2PgPLVBvkmLLfwIOKiVOl", Name = "__slot_H2PgPLVBvkmLLfwIOKiVOl")]
        public static string __slot_H2PgPLVBvkmLLfwIOKiVOl = "numbers and letters\r\nhyphen allowed in between\r\nending with a '.'";
        [n1.ElementAttribute(TracingId = 274161U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "CjCnSglfsh7PEs5q6Vylee", Name = "__slot_CjCnSglfsh7PEs5q6Vylee")]
        public static string __slot_CjCnSglfsh7PEs5q6Vylee = ".";
        [n1.ElementAttribute(TracingId = 274169U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "UytFZBa6bOEOdJP9qn4zsw", Name = "__slot_UytFZBa6bOEOdJP9qn4zsw")]
        public static string __slot_UytFZBa6bOEOdJP9qn4zsw = "blabla.x.com ";
        [n1.ElementAttribute(TracingId = 274180U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "AWc7nv1joAMOkkAmAexI4G", Name = "__slot_AWc7nv1joAMOkkAmAexI4G")]
        public static string __slot_AWc7nv1joAMOkkAmAexI4G = "top domain \"com\"\r\ncannot be super long";
        [n1.ElementAttribute(TracingId = 274181U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "IUM9CPUUArgNuVwP1ZnkCF", Name = "__slot_IUM9CPUUArgNuVwP1ZnkCF")]
        public static string __slot_IUM9CPUUArgNuVwP1ZnkCF = "we patched this:";
        [n1.ElementAttribute(TracingId = 274182U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "PCHJofPkH85Pvnvs3aOGsn", Name = "__slot_PCHJofPkH85Pvnvs3aOGsn")]
        public static string __slot_PCHJofPkH85Pvnvs3aOGsn = "as a proof of concept";
        [n1.ElementAttribute(TracingId = 273959U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "JKkxo9QCs0zN84zuYLmCdq", Name = "Expression")]
        public string Expression;
        [n1.ElementAttribute(TracingId = 273943U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "RGmqrzS6x07NtKxVZSO29K", Name = "IsMatch", IsManaged = true, IsAutoGenerated = true)]
        public n3.IsMatch_No3CCkpgB8zO94DQbGm6O4 __p_RGmqrzS6x07NtKxVZSO29K;
        [n1.ElementAttribute(IsAutoGenerated = true)]
        public n14.Spread<string> __pin_group_Input_In_MfDmnNKJytlLx83UoneR7H = default(n14.Spread<string>);
        ...
        internal IsEmail_VLBfcL2fMjXLFtW0rDJYRo __WITH__(string __slot_VmTcE6UsOrNOAhsPLKceUa, string Expression, n3.IsMatch_No3CCkpgB8zO94DQbGm6O4 __p_RGmqrzS6x07NtKxVZSO29K, n14.Spread<string> __pin_group_Input_In_MfDmnNKJytlLx83UoneR7H)
        {
            n3.IsEmail_VLBfcL2fMjXLFtW0rDJYRo that_0 = this;
            if (this.__GetContext__().IsImmutable)
    ...
    [n1.ElementAttribute(TracingId = 274274U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "P7RlkAIt05ZLyx86JF4FWD", Name = "VL_RegexApplication_P7RlkAIt05ZLyx86JF4FWD")]
    [n2.SerializableAttribute]
    ...
    [n1.ElementAttribute(TracingId = 266393U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", Name = "_Operations_")]
    public static partial class _Operations_
    {
        ...
        public static void RegexOptions(bool Ignore_Case_In, bool Culture_Invariant_In, bool Singleline_In, bool Multiline_In, bool Ignore_Pattern_Whitespace_In, bool Compiled_In, bool Explicit_Capture_In, bool Right_To_Left_In, bool ECMAScript_In, out n5.RegexOptions Output_Out)
        {
            ...
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Ignore_Case_In, Input_In: Input_9, Input_2_In: __pad_DfjVudRNFNHNx3UBgOhMVB_0, Output_Out: out n5.RegexOptions Output_10);
            n5.RegexOptions Input_11 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Culture_Invariant_In, Input_In: Input_11, Input_2_In: __pad_QUl9WykPAkBMMn1vJl05jO_1, Output_Out: out n5.RegexOptions Output_12);
            n5.RegexOptions Input_13 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Singleline_In, Input_In: Input_13, Input_2_In: __pad_SeN0JqdMxpkN7Cmrv6NjLf_2, Output_Out: out n5.RegexOptions Output_14);
            n5.RegexOptions Input_15 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Multiline_In, Input_In: Input_15, Input_2_In: __pad_KSk64nuhgPxLOuCNQXAaaR_3, Output_Out: out n5.RegexOptions Output_16);
            n5.RegexOptions Input_17 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Ignore_Pattern_Whitespace_In, Input_In: Input_17, Input_2_In: __pad_Lf1xyI4ylsiOoYVqkkLAkD_4, Output_Out: out n5.RegexOptions Output_18);
            n5.RegexOptions Input_19 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Compiled_In, Input_In: Input_19, Input_2_In: __pad_O2hsX6RRXosNUVB7LM5E5Y_5, Output_Out: out n5.RegexOptions Output_20);
            n5.RegexOptions Input_21 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Explicit_Capture_In, Input_In: Input_21, Input_2_In: __pad_KCNE8ydJfSkPVUwPnJtkyu_6, Output_Out: out n5.RegexOptions Output_22);
            n5.RegexOptions Input_23 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: Right_To_Left_In, Input_In: Input_23, Input_2_In: __pad_AbueszNjvqGM1CtSs9Wyo6_7, Output_Out: out n5.RegexOptions Output_24);
            n5.RegexOptions Input_25 = default(n5.RegexOptions);
            n20._Operations_.Switch_Boolean<n5.RegexOptions>(Condition_In: ECMAScript_In, Input_In: Input_25, Input_2_In: __pad_QztiMZp4PeeMuO17StxvJE_8, Output_Out: out n5.RegexOptions Output_26);
        ...
        [n1.ElementAttribute(TracingId = 272074U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "DfjVudRNFNHNx3UBgOhMVB", Name = "__slot_DfjVudRNFNHNx3UBgOhMVB")]
        ...
        [n1.ElementAttribute(TracingId = 272237U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "QUl9WykPAkBMMn1vJl05jO", Name = "__slot_QUl9WykPAkBMMn1vJl05jO")]
        ...
        [n1.ElementAttribute(TracingId = 272174U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "SeN0JqdMxpkN7Cmrv6NjLf", Name = "__slot_SeN0JqdMxpkN7Cmrv6NjLf")]
        ...
        [n1.ElementAttribute(TracingId = 272085U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "KSk64nuhgPxLOuCNQXAaaR", Name = "__slot_KSk64nuhgPxLOuCNQXAaaR")]
        ...
        [n1.ElementAttribute(TracingId = 272189U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "Lf1xyI4ylsiOoYVqkkLAkD", Name = "__slot_Lf1xyI4ylsiOoYVqkkLAkD")]
        ...
        [n1.ElementAttribute(TracingId = 272151U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "O2hsX6RRXosNUVB7LM5E5Y", Name = "__slot_O2hsX6RRXosNUVB7LM5E5Y")]
        ...
        [n1.ElementAttribute(TracingId = 272115U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "KCNE8ydJfSkPVUwPnJtkyu", Name = "__slot_KCNE8ydJfSkPVUwPnJtkyu")]
        ...
        [n1.ElementAttribute(TracingId = 272206U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "AbueszNjvqGM1CtSs9Wyo6", Name = "__slot_AbueszNjvqGM1CtSs9Wyo6")]
        ...
        [n1.ElementAttribute(TracingId = 272222U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "QztiMZp4PeeMuO17StxvJE", Name = "__slot_QztiMZp4PeeMuO17StxvJE")]
...
{
    [n1.ElementAttribute(TracingId = 272729U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "EpZIkcWdU51Px03xnhvg4W", Name = "Themselves_EpZIkcWdU51Px03xnhvg4W")]
    [n2.SerializableAttribute]
    public class Themselves_EpZIkcWdU51Px03xnhvg4W : n1.VLObject, n2.IDisposable
    {
        [n4.CreateNewAttribute]
        public static n7.Themselves_EpZIkcWdU51Px03xnhvg4W Create(n1.NodeContext Node_Context)
        {
        ...
        [n4.CreateDefaultAttribute]
        public static n7.Themselves_EpZIkcWdU51Px03xnhvg4W CreateDefault()
        {
            var instance = new Themselves_EpZIkcWdU51Px03xnhvg4W(n1.NodeContext.Default, n1.VLObject.NewIdentity());
            return instance.__CreateDefault__();
        }

        public n7.Themselves_EpZIkcWdU51Px03xnhvg4W Update(string Input_In, out string Output_Out)
        {
            ...
            n7.Themselves_EpZIkcWdU51Px03xnhvg4W that_11 = this;
            if (this.__GetContext__().IsImmutable)
        ...
        public n7.Themselves_EpZIkcWdU51Px03xnhvg4W __Create__(n1.NodeContext Node_Context)
        {
            n8.RuntimeHelpers.EnsureSufficientExecutionStack();
            string __pad_EOegPLG5PIlL7WLRvLEmac_0 = __slot_EOegPLG5PIlL7WLRvLEmac;
            string Input_1 = "[";
            string Input_3_2 = "]";
            var Output_3 = n9.StringExtensions.Plus(input: Input_1, input2: __pad_EOegPLG5PIlL7WLRvLEmac_0);
            var Output_4 = n9.StringExtensions.Plus(input: Output_3, input2: Input_3_2);
            ...
            n7.Themselves_EpZIkcWdU51Px03xnhvg4W that_8 = this;
            this.__slot_TkKFmbqSTBRNKaDzzjwVJ6 = Output_6;
            this.__cache_G8guRFOYFm4OJNCEXBGkGi = null;
            return that_8;
        }

        public n7.Themselves_EpZIkcWdU51Px03xnhvg4W __CreateDefault__()
        {
            n7.Themselves_EpZIkcWdU51Px03xnhvg4W that_0 = this;
        ...
        [n1.ElementAttribute(TracingId = 272733U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "EOegPLG5PIlL7WLRvLEmac", Name = "__slot_EOegPLG5PIlL7WLRvLEmac")]
        public static string __slot_EOegPLG5PIlL7WLRvLEmac = "\\.\\$\\^\\{\\[\\(\\|\\)\\]\\}\\*\\+\\?\\\\";
        [n1.ElementAttribute(TracingId = 272778U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "TkKFmbqSTBRNKaDzzjwVJ6", Name = "__slot_TkKFmbqSTBRNKaDzzjwVJ6")]
        public n5.Regex __slot_TkKFmbqSTBRNKaDzzjwVJ6;
        [n1.ElementAttribute(TracingId = 272779U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "I5dAu3eIjvaOwkBweMb1UO", Name = "__slot_I5dAu3eIjvaOwkBweMb1UO")]
        public static string __slot_I5dAu3eIjvaOwkBweMb1UO = "replace all of these characters with \"\\\" followed by the character";
        [n1.ElementAttribute(TracingId = 272789U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "RCJ18mDZboDLO7SSjaSqaZ", Name = "__slot_RCJ18mDZboDLO7SSjaSqaZ")]
        public static string __slot_RCJ18mDZboDLO7SSjaSqaZ = "\\$&";
        [n1.ElementAttribute(TracingId = 272794U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "JVaCy7Iw6JTM4r7bWKadIt", Name = "__slot_JVaCy7Iw6JTM4r7bWKadIt")]
        ...
        [n1.ElementAttribute(TracingId = 272737U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "G8guRFOYFm4OJNCEXBGkGi", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
    ...
    public static partial class _Operations_
    {
        ...
        {
            string Input_0 = "\\u";
            var Output_1 = n9.StringExtensions.Plus(input: Input_0, input2: Input_In);
            Output_Out = Output_1;
            return;
        }
        ...
        [n1.ElementAttribute(TracingId = 272619U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "Arqm8QiLixaN6tbKu4tvlx", Name = "__slot_Arqm8QiLixaN6tbKu4tvlx")]
        public static string __slot_Arqm8QiLixaN6tbKu4tvlx = "\\t";
        [n1.ElementAttribute(TracingId = 272631U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "IOTVDyHyFN1NLVjGzjCvy4", Name = "__slot_IOTVDyHyFN1NLVjGzjCvy4")]
        public static string __slot_IOTVDyHyFN1NLVjGzjCvy4 = "\\n";
        [n1.ElementAttribute(TracingId = 272671U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "VvE4ILcK669OlortYXrXZ0", Name = "__slot_VvE4ILcK669OlortYXrXZ0")]
        public static string __slot_VvE4ILcK669OlortYXrXZ0 = "\\r";
        [n1.ElementAttribute(TracingId = 272690U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "E6v2U0ldEJaQKgX2hbb42b", Name = "__slot_E6v2U0ldEJaQKgX2hbb42b")]
        public static string __slot_E6v2U0ldEJaQKgX2hbb42b = "\\r\\n";
        [n1.ElementAttribute(TracingId = 272711U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "J1gVDEClR65OlJ2l04OGRT", Name = "__slot_J1gVDEClR65OlJ2l04OGRT")]
        public static string __slot_J1gVDEClR65OlJ2l04OGRT = "\\x020";
        [n1.ElementAttribute(TracingId = 272724U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "CmXzWxhAzGSOVLLRJaR6kB", Name = "__slot_CmXzWxhAzGSOVLLRJaR6kB")]
...
namespace _VL_Regex_.Text.RegularExpressions.Patched.CharacterClasses.Experimental
{
    ...
    public static partial class _Operations_
    {
        public static void AnyOfTheseChars([n4.SerializedDefaultValueAttribute("VL", false)] string Input_In, out string Output_Out)
        {
            string Input_0 = "[";
            string Input_3_1 = "]";
            var Output_2 = n9.StringExtensions.Plus(input: Input_0, input2: Input_In);
            var Output_3 = n9.StringExtensions.Plus(input: Output_2, input2: Input_3_1);
            Output_Out = Output_3;
            return;
        }
        ...
        public static void CharRange([n4.SerializedDefaultValueAttribute("A", false)] string Input_In, [n4.SerializedDefaultValueAttribute("Z", false)] string Input_2_In, out string Output_Out)
        {
            ...
            string Input_3_1 = "-";
            string Input_5_2 = "";
            var Output_3 = n9.StringExtensions.Plus(input: Input_0, input2: Input_In);
            var Output_4 = n9.StringExtensions.Plus(input: Output_3, input2: Input_3_1);
            var Output_5 = n9.StringExtensions.Plus(input: Output_4, input2: Input_2_In);
            var Output_6 = n9.StringExtensions.Plus(input: Output_5, input2: Input_5_2);
            Output_Out = Output_6;
            return;
        }

        [n1.ElementAttribute(TracingId = 272896U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "DSJMDiaFCJZNBVP3qzALbj", Name = "__slot_DSJMDiaFCJZNBVP3qzALbj")]
        public static string __slot_DSJMDiaFCJZNBVP3qzALbj = "\\w";
        [n1.ElementAttribute(TracingId = 272909U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "IvNade5Q4DeNje0nbibiSS", Name = "__slot_IvNade5Q4DeNje0nbibiSS")]
        public static string __slot_IvNade5Q4DeNje0nbibiSS = "\\s";
        [n1.ElementAttribute(TracingId = 272924U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "DHHJPPGRIo9Nw9cbjm203e", Name = "__slot_DHHJPPGRIo9Nw9cbjm203e")]
        public static string __slot_DHHJPPGRIo9Nw9cbjm203e = ".";
        [n1.ElementAttribute(TracingId = 272936U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "I3bkjhkjw43NRuiqt4TME8", Name = "__slot_I3bkjhkjw43NRuiqt4TME8")]
        public static string __slot_I3bkjhkjw43NRuiqt4TME8 = "\\W";
        [n1.ElementAttribute(TracingId = 272977U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "S49l70zzW4NObAotkDhp9W", Name = "__slot_S49l70zzW4NObAotkDhp9W")]
        public static string __slot_S49l70zzW4NObAotkDhp9W = "\\S";
        [n1.ElementAttribute(TracingId = 272995U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "G8VoRVElxcKMGKXnyzJdVZ", Name = "__slot_G8VoRVElxcKMGKXnyzJdVZ")]
        public static string __slot_G8VoRVElxcKMGKXnyzJdVZ = "\\d";
        [n1.ElementAttribute(TracingId = 273011U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "K59Sg1k1ZIDP0yWd47S6r4", Name = "__slot_K59Sg1k1ZIDP0yWd47S6r4")]
...
namespace _VL_Regex_.Text.RegularExpressions.Patched.Quantifiers.Experimental
{
    ...
    public static partial class _Operations_
    {
        ...
        {
            string Input_2_0 = "*";
            var Output_1 = n9.StringExtensions.Plus(input: Input_In, input2: Input_2_0);
            Output_Out = Output_1;
            return;
        }
        ...
        {
            var Result_0 = n11.ObjectHelpers.ToString(input: N_In);
            string Input_1 = "{";
            string Input_3_2 = "}";
            var Output_3 = n9.StringExtensions.Plus(input: Input_1, input2: Result_0);
            var Output_4 = n9.StringExtensions.Plus(input: Output_3, input2: Input_3_2);
            var Output_5 = n9.StringExtensions.Plus(input: Input_In, input2: Output_4);
            Output_Out = Output_5;
            return;
        }
        ...
        {
            var Result_0 = n11.ObjectHelpers.ToString(input: N_In);
            var Result_1 = n11.ObjectHelpers.ToString(input: M_In);
            string Input_2 = "{";
            string Input_3_3 = ",";
            string Input_5_4 = "}";
            var Output_5 = n9.StringExtensions.Plus(input: Input_2, input2: Result_0);
            var Output_6 = n9.StringExtensions.Plus(input: Output_5, input2: Input_3_3);
            var Output_7 = n9.StringExtensions.Plus(input: Output_6, input2: Result_1);
            var Output_8 = n9.StringExtensions.Plus(input: Output_7, input2: Input_5_4);
            var Output_9 = n9.StringExtensions.Plus(input: Input_In, input2: Output_8);
            Output_Out = Output_9;
            return;
        }
...
namespace _VL_Regex_.Text.RegularExpressions.Patched.Anchors.Experimental
{
    ...
    public static partial class _Operations_
    {
        ...
        [n1.ElementAttribute(TracingId = 273365U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "EmmdmoUNh9gQVxaeAY1UcB", Name = "__slot_EmmdmoUNh9gQVxaeAY1UcB")]
        public static string __slot_EmmdmoUNh9gQVxaeAY1UcB = "^";
        [n1.ElementAttribute(TracingId = 273380U, DocumentId = "BrdqoPCUQm5MjX4cJz5Rvf", PersistentId = "LdAEnDIfUAUMV05gzgrg2r", Name = "__slot_LdAEnDIfUAUMV05gzgrg2r")]
...
namespace _VL_Regex_.Text.RegularExpressions.Patched.Groups.Experimental
{
    ...
    public static partial class _Operations_
    {
        ...
        public static void GroupAndName([n4.SerializedDefaultValueAttribute("", false)] string Input_In, [n4.SerializedDefaultValueAttribute("Foo", false)] string Name_In, out string Output_Out)
        {
            ...
            string Input_3_1 = ">";
            string Input_5_2 = ")";
            var Output_3 = n9.StringExtensions.Plus(input: Input_0, input2: Name_In);
            var Output_4 = n9.StringExtensions.Plus(input: Output_3, input2: Input_3_1);
            var Output_5 = n9.StringExtensions.Plus(input: Output_4, input2: Input_In);
            var Output_6 = n9.StringExtensions.Plus(input: Output_5, input2: Input_5_2);
            Output_Out = Output_6;
            return;
        }
        ...
        public static void NotPrecededBy([n4.SerializedDefaultValueAttribute("L", false)] string Input_In, [n4.SerializedDefaultValueAttribute("V", false)] string Input_2_In, out string Output_Out)
        {
            string Input_0 = "(?<!";
            string Input_3_1 = ")";
            var Output_2 = n9.StringExtensions.Plus(input: Input_0, input2: Input_2_In);
            var Output_3 = n9.StringExtensions.Plus(input: Output_2, input2: Input_3_1);
            var Output_4 = n9.StringExtensions.Plus(input: Output_3, input2: Input_In);
            Output_Out = Output_4;
            return;
        }
        ...
        public static void Group_RegExpr([n4.SerializedDefaultValueAttribute("", false)] string Input_In, [n4.SerializedDefaultValueAttribute("", false)] string Input_2_In, out string Output_Out)
        {
            ...
            string Input_4_1 = ")";
            var Output_2 = n9.StringExtensions.Plus(input: Input_0, input2: Input_In);
            var Output_3 = n9.StringExtensions.Plus(input: Output_2, input2: Input_2_In);
            var Output_4 = n9.StringExtensions.Plus(input: Output_3, input2: Input_4_1);
            Output_Out = Output_4;
            return;
        }
    }
...
namespace _VL_Regex_.Text.RegularExpressions.Patched.Alternation.Experimental
{
    ...
    public static partial class _Operations_
    {
        public static void If_RegExpr([n4.SerializedDefaultValueAttribute("", false)] string If_In, string Then_In, string Else_In, out string Output_Out)
        {
            ...
            string Input_5_2 = "|";
            string Input_7_3 = ")";
            var Output_4 = n9.StringExtensions.Plus(input: Input_0, input2: If_In);
            var Output_5 = n9.StringExtensions.Plus(input: Output_4, input2: Input_3_1);
            var Output_6 = n9.StringExtensions.Plus(input: Output_5, input2: Then_In);
            var Output_7 = n9.StringExtensions.Plus(input: Output_6, input2: Input_5_2);
            var Output_8 = n9.StringExtensions.Plus(input: Output_7, input2: Else_In);
            var Output_9 = n9.StringExtensions.Plus(input: Output_8, input2: Input_7_3);
            Output_Out = Output_9;
            return;
        }

        public static void OR_RegExpr([n4.SerializedDefaultValueAttribute("<DefaultValue xmlns=\"property\">\r\n  <Item xmlns=\"\"></Item>\r\n</DefaultValue>", true)] n14.Spread<string> Input_In, out string Output_Out)
        {
            string Value_0 = "(";
            int Capacity_1 = 16;
            var Output_2 = new n12.StringBuilder(value: Value_0, capacity: Capacity_1);
            n13._Operations_.Count<string>(Input_In: Input_In, Count_Out: out int Count_3);
            int Input_2_4 = 1;
            var Output_5 = Count_3 - Input_2_4;
            n12.StringBuilder accumulator_7 = Output_2;
            var i_9 = 0;
            ...
            var Result_18 = n11.ObjectHelpers.ToString(input: accumulator_7);
