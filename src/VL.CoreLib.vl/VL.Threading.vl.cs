...
using n10 = e5::VL.Core.PublicAPI;
...
using n5 = e2::VL.Lib.Threading.ThreadingUtils;
using n13 = e2::VL.Lib.Primitive.CacheRegion;
using n12 = global::System.Threading;
using n1 = e5::VL.Core;
using n2 = global::System;
using n6 = e2::VL.Lib.Threading;
...
{
    [n1.ElementAttribute(TracingId = 271179U, DocumentId = "TRSQqiX8IifNt3AKKsULGv", PersistentId = "FyCN7Vj282lLcqnkwpaV2j", Name = "Lock_FyCN7Vj282lLcqnkwpaV2j")]
    ...
    public class Lock_FyCN7Vj282lLcqnkwpaV2j : n1.VLObject, n2.IDisposable
    {
            ...
            if (Result_2)
            {
                ...
                using (Lock_1)
                {
                    if (state_4 == null)
                    {
                        ...
                        n1.NodeContext Node_Context_5 = __GetContext__().CreateSubContext("TRSQqiX8IifNt3AKKsULGv", "LFZsZfP2rlCP3Bu2NC36ga", 271221U);
        ...
        public class __RCFqByZuIYwNB7eac2FbDK : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 271221U, DocumentId = "TRSQqiX8IifNt3AKKsULGv", PersistentId = "LFZsZfP2rlCP3Bu2NC36ga", Name = "CustomRegionPatch", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 271329U, DocumentId = "TRSQqiX8IifNt3AKKsULGv", PersistentId = "ERguMxLK1NKQZpEFFt1hQj", Name = "Lock_InterMprocess_ERguMxLK1NKQZpEFFt1hQj")]
    [n2.SerializableAttribute]
    public class Lock_InterMprocess_ERguMxLK1NKQZpEFFt1hQj : n1.VLObject, n2.IDisposable
    {
            ...
            if (Result_12)
            {
                ...
                using (Mutex_Lock_11)
                {
                    if (state_14 == null)
                    {
                        ...
                        n1.NodeContext Node_Context_15 = __GetContext__().CreateSubContext("TRSQqiX8IifNt3AKKsULGv", "AyBdIEFqIAkPkruIxagwnP", 271396U);
        ...
        [n1.ElementAttribute(TracingId = 271333U, DocumentId = "TRSQqiX8IifNt3AKKsULGv", PersistentId = "SwAEgGsxKr3O1r4m4r3YQ6", Name = "Cache", IsManaged = true, IsAutoGenerated = true)]
        ...
        public class __CaFnzBB9S4iP9sAHg8Qf5v : n1.VLObject, n2.IDisposable
        {
            ...
            [n1.ElementAttribute(TracingId = 271396U, DocumentId = "TRSQqiX8IifNt3AKKsULGv", PersistentId = "AyBdIEFqIAkPkruIxagwnP", Name = "CustomRegionPatch", IsManaged = true, IsAutoGenerated = true)]
    ...
    [n1.ElementAttribute(TracingId = 271481U, DocumentId = "TRSQqiX8IifNt3AKKsULGv", PersistentId = "OCB5WhWtDvJM8pGrD6L6oS", Name = "VL_ThreadingApplication_OCB5WhWtDvJM8pGrD6L6oS")]
    [n2.SerializableAttribute]
